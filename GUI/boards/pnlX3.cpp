    ...
    , device(nullptr)
{
    ...
    Connect(Lms1tx1En->GetId(), wxEVT_CHECKBOX, wxCommandEventHandler(pnlX3::OnInputChange), nullptr, this);
    ...
    Connect(cmbLms1Tx1Path->GetId(), wxEVT_CHOICE, wxCommandEventHandler(pnlX3::OnInputChange), nullptr, this);
    ...
    Connect(spinDac1->GetId(), wxEVT_TEXT_ENTER, wxCommandEventHandler(pnlX3::OnDacChange), nullptr, this);
    Connect(spinDac1->GetId(), wxEVT_SPINCTRL, wxCommandEventHandler(pnlX3::OnDacChange), nullptr, this);
    Connect(spinDac1->GetId(), wxEVT_SPIN, wxCommandEventHandler(pnlX3::OnDacChange), nullptr, this);
    ...
    Connect(cmbLms1Rx1Path->GetId(), wxEVT_CHOICE, wxCommandEventHandler(pnlX3::OnInputChange), nullptr, this);
    ...
    Connect(Lms1tx2En->GetId(), wxEVT_CHECKBOX, wxCommandEventHandler(pnlX3::OnInputChange), nullptr, this);
    ...
    Connect(cmbLms1Tx2Path->GetId(), wxEVT_CHOICE, wxCommandEventHandler(pnlX3::OnInputChange), nullptr, this);
    ...
    Connect(spinDac2->GetId(), wxEVT_TEXT_ENTER, wxCommandEventHandler(pnlX3::OnDacChange), nullptr, this);
    Connect(spinDac2->GetId(), wxEVT_SPINCTRL, wxCommandEventHandler(pnlX3::OnDacChange), nullptr, this);
    Connect(spinDac2->GetId(), wxEVT_SPIN, wxCommandEventHandler(pnlX3::OnDacChange), nullptr, this);
    ...
    Connect(cmbLms1Rx2Path->GetId(), wxEVT_CHOICE, wxCommandEventHandler(pnlX3::OnInputChange), nullptr, this);
    ...
    rbLMS1LowFreq->Connect(wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler(pnlX3::OnLMS1LowFreq), nullptr, this);
    ...
    rbLMS1HighFreq->Connect(wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler(pnlX3::OnLMS1HighFreq), nullptr, this);
    ...
    rbLMS1DownLink->Connect(wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler(pnlX3::OnLMS1DownLink), nullptr, this);
    ...
    rbLMS1UpLink->Connect(wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler(pnlX3::OnLMS1UpLink), nullptr, this);
    ...
    Connect(Lms2tx1En->GetId(), wxEVT_CHECKBOX, wxCommandEventHandler(pnlX3::OnInputChange), nullptr, this);
    ...
    Connect(cmbLms2Trx1TPath->GetId(), wxEVT_CHOICE, wxCommandEventHandler(pnlX3::OnInputChange), nullptr, this);
    ...
    Connect(cmbLms2Trx1Path->GetId(), wxEVT_CHOICE, wxCommandEventHandler(pnlX3::OnInputChange), nullptr, this);
    ...
    Connect(Lms2Lna1En->GetId(), wxEVT_CHECKBOX, wxCommandEventHandler(pnlX3::OnInputChange), nullptr, this);
    ...
    Connect(cmbLms2Rx1CPath->GetId(), wxEVT_CHOICE, wxCommandEventHandler(pnlX3::OnInputChange), nullptr, this);
    ...
    Connect(cmbLms2Rx1InPath->GetId(), wxEVT_CHOICE, wxCommandEventHandler(pnlX3::OnInputChange), nullptr, this);
    ...
    Connect(Lms2tx2En->GetId(), wxEVT_CHECKBOX, wxCommandEventHandler(pnlX3::OnInputChange), nullptr, this);
    ...
    Connect(cmbLms2Trx2TPath->GetId(), wxEVT_CHOICE, wxCommandEventHandler(pnlX3::OnInputChange), nullptr, this);
    ...
    Connect(cmbLms2Trx2Path->GetId(), wxEVT_CHOICE, wxCommandEventHandler(pnlX3::OnInputChange), nullptr, this);
    ...
    Connect(Lms2Lna2En->GetId(), wxEVT_CHECKBOX, wxCommandEventHandler(pnlX3::OnInputChange), nullptr, this);
    ...
    Connect(cmbLms2Rx2CPath->GetId(), wxEVT_CHOICE, wxCommandEventHandler(pnlX3::OnInputChange), nullptr, this);
    ...
    Connect(cmbLms2Rx2InPath->GetId(), wxEVT_CHOICE, wxCommandEventHandler(pnlX3::OnInputChange), nullptr, this);
    ...
    rbLMS2DownLink->Connect(wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler(pnlX3::OnLMS2DownLink), nullptr, this);
    ...
    rbLMS2UpLink->Connect(wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler(pnlX3::OnLMS2UpLink), nullptr, this);
    ...
    Connect(cmbLms3Rx1Path->GetId(), wxEVT_CHOICE, wxCommandEventHandler(pnlX3::OnInputChange), nullptr, this);
    ...
    Connect(cmbLms3Rx2Path->GetId(), wxEVT_CHOICE, wxCommandEventHandler(pnlX3::OnInputChange), nullptr, this);
...
{
    // LMS1
    cmbLms1Rx1Path->Disconnect(wxEVT_CHOICE, cmbLms1Rx1Path->GetId(), wxCommandEventHandler(pnlX3::OnInputChange), nullptr, this);
    cmbLms1Tx1Path->Disconnect(wxEVT_CHOICE, cmbLms1Tx1Path->GetId(), wxCommandEventHandler(pnlX3::OnInputChange), nullptr, this);
    cmbLms1Rx2Path->Disconnect(wxEVT_CHOICE, cmbLms1Rx2Path->GetId(), wxCommandEventHandler(pnlX3::OnInputChange), nullptr, this);
    cmbLms1Tx2Path->Disconnect(wxEVT_CHOICE, cmbLms1Tx2Path->GetId(), wxCommandEventHandler(pnlX3::OnInputChange), nullptr, this);

    spinDac1->Disconnect(wxEVT_TEXT_ENTER, spinDac1->GetId(), wxCommandEventHandler(pnlX3::OnDacChange), nullptr, this);
    spinDac1->Disconnect(wxEVT_SPINCTRL, spinDac1->GetId(), wxCommandEventHandler(pnlX3::OnDacChange), nullptr, this);
    spinDac1->Disconnect(wxEVT_SPIN, spinDac1->GetId(), wxCommandEventHandler(pnlX3::OnDacChange), nullptr, this);

    spinDac2->Disconnect(wxEVT_TEXT_ENTER, spinDac2->GetId(), wxCommandEventHandler(pnlX3::OnDacChange), nullptr, this);
    spinDac2->Disconnect(wxEVT_SPINCTRL, spinDac2->GetId(), wxCommandEventHandler(pnlX3::OnDacChange), nullptr, this);
    spinDac2->Disconnect(wxEVT_SPIN, spinDac2->GetId(), wxCommandEventHandler(pnlX3::OnDacChange), nullptr, this);

    // LMS2
    cmbLms2Trx1TPath->Disconnect(
        wxEVT_CHOICE, cmbLms2Trx1TPath->GetId(), wxCommandEventHandler(pnlX3::OnInputChange), nullptr, this);
    cmbLms2Trx1Path->Disconnect(wxEVT_CHOICE, cmbLms2Trx1Path->GetId(), wxCommandEventHandler(pnlX3::OnInputChange), nullptr, this);
    cmbLms2Rx1CPath->Disconnect(wxEVT_CHOICE, cmbLms2Rx1CPath->GetId(), wxCommandEventHandler(pnlX3::OnInputChange), nullptr, this);
    cmbLms2Rx1InPath->Disconnect(
        wxEVT_CHOICE, cmbLms2Rx1InPath->GetId(), wxCommandEventHandler(pnlX3::OnInputChange), nullptr, this);

    cmbLms2Trx2TPath->Disconnect(
        wxEVT_CHOICE, cmbLms2Trx2TPath->GetId(), wxCommandEventHandler(pnlX3::OnInputChange), nullptr, this);
    cmbLms2Trx2Path->Disconnect(wxEVT_CHOICE, cmbLms2Trx2Path->GetId(), wxCommandEventHandler(pnlX3::OnInputChange), nullptr, this);
    cmbLms2Rx2CPath->Disconnect(wxEVT_CHOICE, cmbLms2Rx2CPath->GetId(), wxCommandEventHandler(pnlX3::OnInputChange), nullptr, this);
    cmbLms2Rx2InPath->Disconnect(
        wxEVT_CHOICE, cmbLms2Rx2InPath->GetId(), wxCommandEventHandler(pnlX3::OnInputChange), nullptr, this);

    // LMS3
    cmbLms3Rx1Path->Disconnect(wxEVT_CHOICE, cmbLms3Rx1Path->GetId(), wxCommandEventHandler(pnlX3::OnInputChange), nullptr, this);
    cmbLms3Rx1Path->Disconnect(wxEVT_CHOICE, cmbLms3Rx2Path->GetId(), wxCommandEventHandler(pnlX3::OnInputChange), nullptr, this);
}
