    ...
    : ILMS7002MTab(parent, id, pos, size, style)
{
    ...
    chkRX_CLK_PE =
        new wxCheckBox(sbSizerEngagePullUp->GetStaticBox(), ID_RX_CLK_PE, wxT("RX_CLK pad"), wxDefaultPosition, wxDefaultSize, 0);
    chkRX_CLK_PE->SetToolTip(wxT("Pull up control of RX_CLK pad"));

    fgSizer107->Add(chkRX_CLK_PE, 0, flags, 0);

    chkSDIO_PE =
        new wxCheckBox(sbSizerEngagePullUp->GetStaticBox(), ID_SDIO_PE, wxT("SDIO pad"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkTX_CLK_PE =
        new wxCheckBox(sbSizerEngagePullUp->GetStaticBox(), ID_TX_CLK_PE, wxT("TX_CLK pad"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkDIQ1_PE =
        new wxCheckBox(sbSizerEngagePullUp->GetStaticBox(), ID_DIQ1_PE, wxT("DIQ1 pad"), wxDefaultPosition, wxDefaultSize, 0);
    chkDIQ1_PE->SetToolTip(wxT("Pull up control of DIQ1 pad"));

    fgSizer107->Add(chkDIQ1_PE, 0, flags, 0);

    chkTXNRX1_PE =
        new wxCheckBox(sbSizerEngagePullUp->GetStaticBox(), ID_TXNRX1_PE, wxT("TXNRX1 pad"), wxDefaultPosition, wxDefaultSize, 0);
    chkTXNRX1_PE->SetToolTip(wxT("Pull up control of TXNRX1 pad"));

    fgSizer107->Add(chkTXNRX1_PE, 0, flags, 0);

    chkSCLK_PE =
        new wxCheckBox(sbSizerEngagePullUp->GetStaticBox(), ID_SCLK_PE, wxT("CLK pad"), wxDefaultPosition, wxDefaultSize, 0);
    chkSCLK_PE->SetToolTip(wxT("Pull up control of SCLK pad"));

    fgSizer107->Add(chkSCLK_PE, 0, flags, 0);

    chkDIQ2_PE =
        new wxCheckBox(sbSizerEngagePullUp->GetStaticBox(), ID_DIQ2_PE, wxT("DIQ2 pad"), wxDefaultPosition, wxDefaultSize, 0);
    chkDIQ2_PE->SetToolTip(wxT("Pull up control of DIQ2 pad"));

    fgSizer107->Add(chkDIQ2_PE, 0, flags, 0);

    chkTXNRX2_PE =
        new wxCheckBox(sbSizerEngagePullUp->GetStaticBox(), ID_TXNRX2_PE, wxT("TXNRX2 pad"), wxDefaultPosition, wxDefaultSize, 0);
    chkTXNRX2_PE->SetValue(true);
    chkTXNRX2_PE->SetToolTip(wxT("Pull up control of TXNRX2 pad"));

    fgSizer107->Add(chkTXNRX2_PE, 0, flags, 0);

    chkIQ_SEL_EN_1_PE = new wxCheckBox(
        sbSizerEngagePullUp->GetStaticBox(), ID_IQ_SEL_EN_1_PE, wxT("IQ_SEL_EN_1 pad"), wxDefaultPosition, wxDefaultSize, 0);
    chkIQ_SEL_EN_1_PE->SetToolTip(wxT("Pull up control of IQ_SEL_EN_1 pad"));

    fgSizer107->Add(chkIQ_SEL_EN_1_PE, 0, flags, 0);

    chkFCLK1_PE =
        new wxCheckBox(sbSizerEngagePullUp->GetStaticBox(), ID_FCLK1_PE, wxT("FCLK1 pad"), wxDefaultPosition, wxDefaultSize, 0);
    chkFCLK1_PE->SetToolTip(wxT("Pull up control of FCLK1 pad"));

    fgSizer107->Add(chkFCLK1_PE, 0, flags, 0);

    chkMCLK1_PE =
        new wxCheckBox(sbSizerEngagePullUp->GetStaticBox(), ID_MCLK1_PE, wxT("MCLK1 pad"), wxDefaultPosition, wxDefaultSize, 0);
    chkMCLK1_PE->SetToolTip(wxT("Pull up control of MCLK1 pad"));

    fgSizer107->Add(chkMCLK1_PE, 0, flags, 0);

    chkIQ_SEL_EN_2_PE = new wxCheckBox(
        sbSizerEngagePullUp->GetStaticBox(), ID_IQ_SEL_EN_2_PE, wxT("IQ_SEL_EN_2 pad"), wxDefaultPosition, wxDefaultSize, 0);
    chkIQ_SEL_EN_2_PE->SetToolTip(wxT("Pull up control of IQ_SEL_EN_2 pad"));

    fgSizer107->Add(chkIQ_SEL_EN_2_PE, 0, flags, 0);

    chkFCLK2_PE =
        new wxCheckBox(sbSizerEngagePullUp->GetStaticBox(), ID_FCLK2_PE, wxT("FCLK2 pad"), wxDefaultPosition, wxDefaultSize, 0);
    chkFCLK2_PE->SetToolTip(wxT("Pull up control of FCLK2 pad"));

    fgSizer107->Add(chkFCLK2_PE, 0, flags, 0);

    chkMCLK2_PE =
        new wxCheckBox(sbSizerEngagePullUp->GetStaticBox(), ID_MCLK2_PE, wxT("MCLK2 pad"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkSRST_RXFIFO = new wxCheckBox(
        sbSizerResetSignals->GetStaticBox(), ID_SRST_RXFIFO, wxT("Rx FIFO soft reset"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkSRST_TXFIFO = new wxCheckBox(
        sbSizerResetSignals->GetStaticBox(), ID_SRST_TXFIFO, wxT("Tx FIFO soft reset"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    sbSizerLogicRegistersReset =
        new wxStaticBoxSizer(new wxStaticBox(sbSizerResetSignals->GetStaticBox(), wxID_ANY, wxT("Logic registers")), wxVERTICAL);

    chkLRST_TX_A = new wxCheckBox(
        sbSizerLogicRegistersReset->GetStaticBox(), ID_LRST_TX_A, wxT("Tx MIMO ch. A"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkLRST_TX_B = new wxCheckBox(
        sbSizerLogicRegistersReset->GetStaticBox(), ID_LRST_TX_B, wxT("Tx MIMO ch. B"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkLRST_RX_A = new wxCheckBox(
        sbSizerLogicRegistersReset->GetStaticBox(), ID_LRST_RX_A, wxT("Rx MIMO ch. A"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkLRST_RX_B = new wxCheckBox(
        sbSizerLogicRegistersReset->GetStaticBox(), ID_LRST_RX_B, wxT("Rx MIMO ch. B"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    sbSizerConfigurationMemoryReset = new wxStaticBoxSizer(
        new wxStaticBox(sbSizerResetSignals->GetStaticBox(), wxID_ANY, wxT("Configuration memory")), wxVERTICAL);

    chkMRST_TX_A = new wxCheckBox(
        sbSizerConfigurationMemoryReset->GetStaticBox(), ID_MRST_TX_A, wxT("Tx MIMO ch. A"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkMRST_TX_B = new wxCheckBox(
        sbSizerConfigurationMemoryReset->GetStaticBox(), ID_MRST_TX_B, wxT("Tx MIMO ch. B"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkMRST_RX_A = new wxCheckBox(
        sbSizerConfigurationMemoryReset->GetStaticBox(), ID_MRST_RX_A, wxT("Rx MIMO ch. A"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkMRST_RX_B = new wxCheckBox(
        sbSizerConfigurationMemoryReset->GetStaticBox(), ID_MRST_RX_B, wxT("Rx MIMO ch. B"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkRXEN_A = new wxCheckBox(
        sbSizerPowerControls->GetStaticBox(), ID_RXEN_A, wxT("Enable Rx MIMO ch. A"), wxDefaultPosition, wxDefaultSize, 0);
    chkRXEN_A->SetToolTip(wxT("Power control for Rx MIMO channel A"));

    fgSizer113->Add(chkRXEN_A, 0, flags, 0);

    chkTXEN_A = new wxCheckBox(
        sbSizerPowerControls->GetStaticBox(), ID_TXEN_A, wxT("Enable Tx MIMO ch. A"), wxDefaultPosition, wxDefaultSize, 0);
    chkTXEN_A->SetToolTip(wxT("Power control for Tx MIMO channel A"));

    fgSizer113->Add(chkTXEN_A, 0, flags, 0);

    chkRXEN_B = new wxCheckBox(
        sbSizerPowerControls->GetStaticBox(), ID_RXEN_B, wxT("Enable Rx MIMO ch. B"), wxDefaultPosition, wxDefaultSize, 0);
    chkRXEN_B->SetToolTip(wxT("Power control for Rx MIMO channel B"));

    fgSizer113->Add(chkRXEN_B, 0, flags, 0);

    chkTXEN_B = new wxCheckBox(
        sbSizerPowerControls->GetStaticBox(), ID_TXEN_B, wxT("Enable Tx MIMO ch. B"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkMOD_EN = new wxCheckBox(
        sbSizerLimeLightModes->GetStaticBox(), ID_MOD_EN, wxT("Enable LimeLight interface"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    rgrLML_FIDM1 = new wxRadioBox(sbSizerLimeLightModes->GetStaticBox(),
        ID_LML_FIDM1,
        wxT("Frame start for Port 1"),
        wxDefaultPosition,
        wxDefaultSize,
        rgrLML_FIDM1NChoices,
        rgrLML_FIDM1Choices,
        2,
        wxRA_SPECIFY_COLS);
    ...
    rgrLML_FIDM2 = new wxRadioBox(sbSizerLimeLightModes->GetStaticBox(),
        ID_LML_FIDM2,
        wxT("Frame start for Port 2"),
        wxDefaultPosition,
        wxDefaultSize,
        rgrLML_FIDM2NChoices,
        rgrLML_FIDM2Choices,
        2,
        wxRA_SPECIFY_COLS);
    ...
    rgrLML_MODE1 = new wxRadioBox(sbSizerLimeLightModes->GetStaticBox(),
        ID_LML_MODE1,
        wxT("LimeLight port 1 mode"),
        wxDefaultPosition,
        wxDefaultSize,
        rgrLML_MODE1NChoices,
        rgrLML_MODE1Choices,
        2,
        wxRA_SPECIFY_COLS);
    ...
    rgrLML_MODE2 = new wxRadioBox(sbSizerLimeLightModes->GetStaticBox(),
        ID_LML_MODE2,
        wxT("LimeLight port 2 mode"),
        wxDefaultPosition,
        wxDefaultSize,
        rgrLML_MODE2NChoices,
        rgrLML_MODE2Choices,
        2,
        wxRA_SPECIFY_COLS);
    ...
    rgrLML_TXNRXIQ1 = new wxRadioBox(sbSizerLimeLightModes->GetStaticBox(),
        ID_LML_TXNRXIQ1,
        wxT("Port 1 mode selection"),
        wxDefaultPosition,
        wxDefaultSize,
        rgrLML_TXNRXIQ1NChoices,
        rgrLML_TXNRXIQ1Choices,
        2,
        wxRA_SPECIFY_COLS);
    ...
    rgrLML_TXNRXIQ2 = new wxRadioBox(sbSizerLimeLightModes->GetStaticBox(),
        ID_LML_TXNRXIQ2,
        wxT("Port 2 mode selection"),
        wxDefaultPosition,
        wxDefaultSize,
        rgrLML_TXNRXIQ2NChoices,
        rgrLML_TXNRXIQ2Choices,
        2,
        wxRA_SPECIFY_COLS);
    ...
    chkLML1_TRXIQPULSE = new wxCheckBox(
        sbSizerLimeLightModes->GetStaticBox(), ID_TXEN_B, wxT("LML1 TRXIQPULSE mode"), wxDefaultPosition, wxDefaultSize, 0);
    chkLML1_TRXIQPULSE->SetToolTip(wxT("Power control for Tx MIMO channel B"));

    fgSizer108->Add(chkLML1_TRXIQPULSE, 0, wxALIGN_LEFT, 0);

    chkLML2_TRXIQPULSE = new wxCheckBox(
        sbSizerLimeLightModes->GetStaticBox(), ID_TXEN_B, wxT("LML2 TRXIQPULSE mode"), wxDefaultPosition, wxDefaultSize, 0);
    chkLML2_TRXIQPULSE->SetToolTip(wxT("Power control for Tx MIMO channel B"));

    fgSizer108->Add(chkLML2_TRXIQPULSE, 0, wxALIGN_LEFT, 0);

    chkLML1_SISODDR = new wxCheckBox(
        sbSizerLimeLightModes->GetStaticBox(), ID_TXEN_B, wxT("LML1 SISODDR mode"), wxDefaultPosition, wxDefaultSize, 0);
    chkLML1_SISODDR->SetToolTip(wxT("Power control for Tx MIMO channel B"));

    fgSizer108->Add(chkLML1_SISODDR, 0, wxALIGN_LEFT, 0);

    chkLML2_SISODDR = new wxCheckBox(
        sbSizerLimeLightModes->GetStaticBox(), ID_TXEN_B, wxT("LML2 SISODDR mode"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    rgrSDA_DS = new wxRadioBox(sbSizerDriverStrength->GetStaticBox(),
        ID_SDA_DS,
        wxT("SDA pad"),
        wxDefaultPosition,
        wxDefaultSize,
    ...
    rgrSCL_DS = new wxRadioBox(sbSizerDriverStrength->GetStaticBox(),
        ID_SCL_DS,
        wxT("SCL pad"),
        wxDefaultPosition,
        wxDefaultSize,
    ...
    rgrSDIO_DS = new wxRadioBox(sbSizerDriverStrength->GetStaticBox(),
        ID_SDIO_DS,
        wxT("SDIO pad"),
        wxDefaultPosition,
        wxDefaultSize,
    ...
    rgrDIQ2_DS = new wxRadioBox(sbSizerDriverStrength->GetStaticBox(),
        ID_DIQ2_DS,
        wxT("DIQ2 pad"),
        wxDefaultPosition,
        wxDefaultSize,
    ...
    rgrDIQ1_DS = new wxRadioBox(sbSizerDriverStrength->GetStaticBox(),
        ID_DIQ1_DS,
        wxT("DIQ1 pad"),
        wxDefaultPosition,
        wxDefaultSize,
    ...
    rgrRX_MUX = new wxRadioBox(ID_PANEL1,
        ID_RX_MUX,
        wxT("RxFIFO source"),
        wxDefaultPosition,
        wxDefaultSize,
    ...
    rgrTX_MUX = new wxRadioBox(ID_PANEL1,
        ID_TX_MUX,
        wxT("Data transmit port"),
        wxDefaultPosition,
        wxDefaultSize,
        rgrTX_MUXNChoices,
        rgrTX_MUXChoices,
    ...
    rgrSPIMODE = new wxRadioBox(ID_PANEL1,
        ID_SPIMODE,
        wxT("SPI mode"),
        wxDefaultPosition,
        wxDefaultSize,
    ...
    sbSizer87 = new wxStaticBoxSizer(
        new wxStaticBox(sbSizerSampleSource->GetStaticBox(), wxID_ANY, wxT("When Port 1 is RF2BB")), wxVERTICAL);
    ...
    sbSizer89 = new wxStaticBoxSizer(
        new wxStaticBox(sbSizerSampleSource->GetStaticBox(), wxID_ANY, wxT("When Port 2 is RF2BB")), wxVERTICAL);
    ...
    sbSizer88 = new wxStaticBoxSizer(
        new wxStaticBox(sbSizerSamplePositions->GetStaticBox(), wxID_ANY, wxT("When Port 1 is BB2RF")), wxVERTICAL);
    ...
    ID_STATICTEXT5 =
        new wxStaticText(sbSizer88->GetStaticBox(), wxID_ANY, wxT("BQ sample position"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    ID_STATICTEXT6 =
        new wxStaticText(sbSizer88->GetStaticBox(), wxID_ANY, wxT("BI sample position"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    ID_STATICTEXT7 =
        new wxStaticText(sbSizer88->GetStaticBox(), wxID_ANY, wxT("AQ sample position"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    ID_STATICTEXT8 =
        new wxStaticText(sbSizer88->GetStaticBox(), wxID_ANY, wxT("AI sample position"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    sbSizer90 = new wxStaticBoxSizer(
        new wxStaticBox(sbSizerSamplePositions->GetStaticBox(), wxID_ANY, wxT("When Port 2 is BB2RF")), wxVERTICAL);
    ...
    ID_STATICTEXT13 =
        new wxStaticText(sbSizer90->GetStaticBox(), wxID_ANY, wxT("BQ sample position"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    ID_STATICTEXT14 =
        new wxStaticText(sbSizer90->GetStaticBox(), wxID_ANY, wxT("BI sample position"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    ID_STATICTEXT15 =
        new wxStaticText(sbSizer90->GetStaticBox(), wxID_ANY, wxT("AQ sample position"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    ID_STATICTEXT16 =
        new wxStaticText(sbSizer90->GetStaticBox(), wxID_ANY, wxT("AI sample position"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    ID_STATICTEXT25 = new wxStaticText(
        sbSizerClockControls->GetStaticBox(), wxID_ANY, wxT("TX FIFO read clock source"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    ID_STATICTEXT26 = new wxStaticText(
        sbSizerClockControls->GetStaticBox(), wxID_ANY, wxT("Tx FIFO write clock source"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    ID_STATICTEXT27 = new wxStaticText(
        sbSizerClockControls->GetStaticBox(), wxID_ANY, wxT("Rx FIFO read clock source"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    ID_STATICTEXT28 = new wxStaticText(
        sbSizerClockControls->GetStaticBox(), wxID_ANY, wxT("Rx FIFO write clock source"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    ID_STATICTEXT29 = new wxStaticText(
        sbSizerClockControls->GetStaticBox(), wxID_ANY, wxT("MCLK2 clock source"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    ID_STATICTEXT30 = new wxStaticText(
        sbSizerClockControls->GetStaticBox(), wxID_ANY, wxT("MCLK1 clock source"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkTXDIVEN = new wxCheckBox(
        sbSizerClockControls->GetStaticBox(), ID_TXDIVEN, wxT("Enable Tx clock divider"), wxDefaultPosition, wxDefaultSize, 0);
    chkTXDIVEN->SetToolTip(wxT("TX clock divider enable"));

    fgSizer122->Add(chkTXDIVEN, 0, wxALIGN_CENTER_VERTICAL, 0);

    cmbTXTSPCLKA_DIV = new wxSpinCtrl(sbSizerClockControls->GetStaticBox(),
        ID_TXTSPCLKA_DIV,
        wxEmptyString,
        wxDefaultPosition,
        wxDefaultSize,
    ...
    chkRXDIVEN = new wxCheckBox(
        sbSizerClockControls->GetStaticBox(), ID_RXDIVEN, wxT("Enable Rx clock divider"), wxDefaultPosition, wxDefaultSize, 0);
    chkRXDIVEN->SetToolTip(wxT("RX clock divider enable"));

    fgSizer122->Add(chkRXDIVEN, 0, wxALIGN_CENTER_VERTICAL, 0);

    cmbRXTSPCLKA_DIV = new wxSpinCtrl(sbSizerClockControls->GetStaticBox(),
        ID_RXTSPCLKA_DIV,
        wxEmptyString,
        wxDefaultPosition,
        wxDefaultSize,
    ...
    chkFCLK1_INV = new wxCheckBox(
        sbSizerClockControls->GetStaticBox(), ID_FCLK1_INV, wxT("FCLK1 invert"), wxDefaultPosition, wxDefaultSize, 0);
    chkFCLK1_INV->SetToolTip(wxT("FCLK1 clock inversion"));

    fgSizer122->Add(chkFCLK1_INV, 1, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);

    chkFCLK2_INV = new wxCheckBox(
        sbSizerClockControls->GetStaticBox(), ID_FCLK2_INV, wxT("FCLK2 invert"), wxDefaultPosition, wxDefaultSize, 0);
    chkFCLK2_INV->SetToolTip(wxT("FCLK2 clock inversion"));

    fgSizer122->Add(chkFCLK2_INV, 1, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);

    chkMCLK1_INV = new wxCheckBox(
        sbSizerClockControls->GetStaticBox(), ID_FCLK2_INV, wxT("MCLK1 invert"), wxDefaultPosition, wxDefaultSize, 0);
    chkMCLK1_INV->SetToolTip(wxT("FCLK2 clock inversion"));

    fgSizer122->Add(chkMCLK1_INV, 0, wxALIGN_CENTER_VERTICAL | wxALIGN_LEFT, 0);

    chkMCLK2_INV = new wxCheckBox(
        sbSizerClockControls->GetStaticBox(), ID_FCLK2_INV, wxT("MCLK2 invert"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    ID_STATICTEXT301 =
        new wxStaticText(sbSizerClockControls->GetStaticBox(), wxID_ANY, wxT("FCLK1 delay"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    ID_STATICTEXT302 =
        new wxStaticText(sbSizerClockControls->GetStaticBox(), wxID_ANY, wxT("FCLK2 delay"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    ID_STATICTEXT303 =
        new wxStaticText(sbSizerClockControls->GetStaticBox(), wxID_ANY, wxT("MCLK1 delay"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    ID_STATICTEXT304 =
        new wxStaticText(sbSizerClockControls->GetStaticBox(), wxID_ANY, wxT("MCLK2 delay"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    sbSizerClockCyclesToWaitLML1 =
        new wxStaticBoxSizer(new wxStaticBox(ID_PANEL2, wxID_ANY, wxT("LML1 Clock cycles to wait before")), wxHORIZONTAL);
    ...
    ID_STATICTEXT17 = new wxStaticText(
        sbSizerClockCyclesToWaitLML1->GetStaticBox(), wxID_ANY, wxT("Data drive stop"), wxDefaultPosition, wxDefaultSize, 0);
    ID_STATICTEXT17->Wrap(-1);
    fgSizer125->Add(ID_STATICTEXT17, 0, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 0);

    cmbLML1_TX_PST = new wxSpinCtrl(sbSizerClockCyclesToWaitLML1->GetStaticBox(),
        ID_LML1_TX_PST,
        wxEmptyString,
        wxDefaultPosition,
        wxDefaultSize,
    ...
    ID_STATICTEXT18 = new wxStaticText(
        sbSizerClockCyclesToWaitLML1->GetStaticBox(), wxID_ANY, wxT("Data drive start"), wxDefaultPosition, wxDefaultSize, 0);
    ID_STATICTEXT18->Wrap(-1);
    fgSizer125->Add(ID_STATICTEXT18, 0, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 0);

    cmbLML1_TX_PRE = new wxSpinCtrl(sbSizerClockCyclesToWaitLML1->GetStaticBox(),
        ID_LML1_TX_PRE,
        wxEmptyString,
        wxDefaultPosition,
        wxDefaultSize,
    ...
    ID_STATICTEXT19 = new wxStaticText(
        sbSizerClockCyclesToWaitLML1->GetStaticBox(), wxID_ANY, wxT("Data capture stop"), wxDefaultPosition, wxDefaultSize, 0);
    ID_STATICTEXT19->Wrap(-1);
    fgSizer125->Add(ID_STATICTEXT19, 0, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 0);

    cmbLML1_RX_PST = new wxSpinCtrl(sbSizerClockCyclesToWaitLML1->GetStaticBox(),
        ID_LML1_RX_PST,
        wxEmptyString,
        wxDefaultPosition,
        wxDefaultSize,
    ...
    ID_STATICTEXT20 = new wxStaticText(
        sbSizerClockCyclesToWaitLML1->GetStaticBox(), wxID_ANY, wxT("Data capture start"), wxDefaultPosition, wxDefaultSize, 0);
    ID_STATICTEXT20->Wrap(-1);
    fgSizer125->Add(ID_STATICTEXT20, 0, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 0);

    cmbLML1_RX_PRE = new wxSpinCtrl(sbSizerClockCyclesToWaitLML1->GetStaticBox(),
        ID_LML1_RX_PRE,
        wxEmptyString,
        wxDefaultPosition,
        wxDefaultSize,
    ...
    sbSizerClockCyclesToWaitLML2 =
        new wxStaticBoxSizer(new wxStaticBox(ID_PANEL2, wxID_ANY, wxT("LML2 Clock cycles to wait before")), wxHORIZONTAL);
    ...
    ID_STATICTEXT21 = new wxStaticText(
        sbSizerClockCyclesToWaitLML2->GetStaticBox(), wxID_ANY, wxT("Data drive stop"), wxDefaultPosition, wxDefaultSize, 0);
    ID_STATICTEXT21->Wrap(-1);
    fgSizer126->Add(ID_STATICTEXT21, 0, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 0);

    cmbLML2_TX_PST = new wxSpinCtrl(sbSizerClockCyclesToWaitLML2->GetStaticBox(),
        ID_LML2_TX_PST,
        wxEmptyString,
        wxDefaultPosition,
        wxDefaultSize,
    ...
    ID_STATICTEXT22 = new wxStaticText(
        sbSizerClockCyclesToWaitLML2->GetStaticBox(), wxID_ANY, wxT("Data drive start"), wxDefaultPosition, wxDefaultSize, 0);
    ID_STATICTEXT22->Wrap(-1);
    fgSizer126->Add(ID_STATICTEXT22, 0, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 0);

    cmbLML2_TX_PRE = new wxSpinCtrl(sbSizerClockCyclesToWaitLML2->GetStaticBox(),
        ID_LML2_TX_PRE,
        wxEmptyString,
        wxDefaultPosition,
        wxDefaultSize,
    ...
    ID_STATICTEXT23 = new wxStaticText(
        sbSizerClockCyclesToWaitLML2->GetStaticBox(), wxID_ANY, wxT("Data capture stop"), wxDefaultPosition, wxDefaultSize, 0);
    ID_STATICTEXT23->Wrap(-1);
    fgSizer126->Add(ID_STATICTEXT23, 0, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 0);

    cmbLML2_RX_PST = new wxSpinCtrl(sbSizerClockCyclesToWaitLML2->GetStaticBox(),
        ID_LML2_RX_PST,
        wxEmptyString,
        wxDefaultPosition,
        wxDefaultSize,
    ...
    ID_STATICTEXT24 = new wxStaticText(
        sbSizerClockCyclesToWaitLML2->GetStaticBox(), wxID_ANY, wxT("Data capture start"), wxDefaultPosition, wxDefaultSize, 0);
    ID_STATICTEXT24->Wrap(-1);
    fgSizer126->Add(ID_STATICTEXT24, 0, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 0);

    cmbLML2_RX_PRE = new wxSpinCtrl(sbSizerClockCyclesToWaitLML2->GetStaticBox(),
        ID_LML2_RX_PRE,
        wxEmptyString,
        wxDefaultPosition,
        wxDefaultSize,
    ...
    rgrDIQDIRCTR1 = new wxRadioBox(sbSizerDirectionControls->GetStaticBox(),
        ID_DIQDIRCTR1,
        wxT("DIQ1 mode"),
        wxDefaultPosition,
        wxDefaultSize,
        rgrDIQDIRCTR1NChoices,
        rgrDIQDIRCTR1Choices,
        1,
        wxRA_SPECIFY_COLS);
    ...
    rgrDIQDIR1 = new wxRadioBox(sbSizerDirectionControls->GetStaticBox(),
        ID_DIQDIR1,
        wxT("DIQ1 direction"),
        wxDefaultPosition,
        wxDefaultSize,
    ...
    rgrENABLEDIRCTR1 = new wxRadioBox(sbSizerDirectionControls->GetStaticBox(),
        ID_ENABLEDIRCTR1,
        wxT("ENABLE1 mode"),
        wxDefaultPosition,
        wxDefaultSize,
        rgrENABLEDIRCTR1NChoices,
        rgrENABLEDIRCTR1Choices,
        1,
        wxRA_SPECIFY_COLS);
    ...
    rgrENABLEDIR1 = new wxRadioBox(sbSizerDirectionControls->GetStaticBox(),
        ID_ENABLEDIR1,
        wxT("ENABLE1 direction"),
        wxDefaultPosition,
        wxDefaultSize,
        rgrENABLEDIR1NChoices,
        rgrENABLEDIR1Choices,
        1,
        wxRA_SPECIFY_COLS);
    ...
    rgrDIQDIRCTR2 = new wxRadioBox(sbSizerDirectionControls->GetStaticBox(),
        ID_DIQDIRCTR2,
        wxT("DIQ2 mode"),
        wxDefaultPosition,
        wxDefaultSize,
        rgrDIQDIRCTR2NChoices,
        rgrDIQDIRCTR2Choices,
        1,
        wxRA_SPECIFY_COLS);
    ...
    rgrDIQDIR2 = new wxRadioBox(sbSizerDirectionControls->GetStaticBox(),
        ID_DIQDIR2,
        wxT("DIQ2 direction"),
        wxDefaultPosition,
        wxDefaultSize,
    ...
    rgrENABLEDIRCTR2 = new wxRadioBox(sbSizerDirectionControls->GetStaticBox(),
        ID_ENABLEDIRCTR2,
        wxT("ENABLE2 mode"),
        wxDefaultPosition,
        wxDefaultSize,
        rgrENABLEDIRCTR2NChoices,
        rgrENABLEDIRCTR2Choices,
        1,
        wxRA_SPECIFY_COLS);
    ...
    rgrENABLEDIR2 = new wxRadioBox(sbSizerDirectionControls->GetStaticBox(),
        ID_ENABLEDIR2,
        wxT("ENABLE2 direction"),
        wxDefaultPosition,
        wxDefaultSize,
        rgrENABLEDIR2NChoices,
        rgrENABLEDIR2Choices,
        1,
        wxRA_SPECIFY_COLS);
    ...
    wndId2Enum[chkDIQ1_PE] = LMS7002MCSR::DIQ1_PE;
    wndId2Enum[rgrDIQ2_DS] = LMS7002MCSR::DIQ2_DS;
    wndId2Enum[chkDIQ2_PE] = LMS7002MCSR::DIQ2_PE;
    wndId2Enum[rgrRX_MUX] = LMS7002MCSR::RX_MUX;
    wndId2Enum[chkFCLK1_PE] = LMS7002MCSR::FCLK1_PE;
    wndId2Enum[chkFCLK2_PE] = LMS7002MCSR::FCLK2_PE;
    wndId2Enum[chkIQ_SEL_EN_1_PE] = LMS7002MCSR::IQ_SEL_EN_1_PE;
    wndId2Enum[chkIQ_SEL_EN_2_PE] = LMS7002MCSR::IQ_SEL_EN_2_PE;
    wndId2Enum[cmbLML1_AIP] = LMS7002MCSR::LML1_AIP;
    wndId2Enum[cmbLML1_AQP] = LMS7002MCSR::LML1_AQP;
    wndId2Enum[cmbLML1_BIP] = LMS7002MCSR::LML1_BIP;
    wndId2Enum[cmbLML1_BQP] = LMS7002MCSR::LML1_BQP;
    wndId2Enum[cmbLML1_RX_PRE] = LMS7002MCSR::LML1_RF2BB_PRE;
    wndId2Enum[cmbLML1_RX_PST] = LMS7002MCSR::LML1_RF2BB_PST;
    wndId2Enum[cmbLML1_S0S] = LMS7002MCSR::LML1_S0S;
    wndId2Enum[cmbLML1_S1S] = LMS7002MCSR::LML1_S1S;
    wndId2Enum[cmbLML1_S2S] = LMS7002MCSR::LML1_S2S;
    wndId2Enum[cmbLML1_S3S] = LMS7002MCSR::LML1_S3S;
    wndId2Enum[cmbLML1_TX_PRE] = LMS7002MCSR::LML1_BB2RF_PRE;
    wndId2Enum[cmbLML1_TX_PST] = LMS7002MCSR::LML1_BB2RF_PST;
    wndId2Enum[cmbLML2_AIP] = LMS7002MCSR::LML2_AIP;
    wndId2Enum[cmbLML2_AQP] = LMS7002MCSR::LML2_AQP;
    wndId2Enum[cmbLML2_BIP] = LMS7002MCSR::LML2_BIP;
    wndId2Enum[cmbLML2_BQP] = LMS7002MCSR::LML2_BQP;
    wndId2Enum[cmbLML2_RX_PRE] = LMS7002MCSR::LML2_RF2BB_PRE;
    wndId2Enum[cmbLML2_RX_PST] = LMS7002MCSR::LML2_RF2BB_PST;
    wndId2Enum[cmbLML2_S0S] = LMS7002MCSR::LML2_S0S;
    wndId2Enum[cmbLML2_S1S] = LMS7002MCSR::LML2_S1S;
    wndId2Enum[cmbLML2_S2S] = LMS7002MCSR::LML2_S2S;
    wndId2Enum[cmbLML2_S3S] = LMS7002MCSR::LML2_S3S;
    wndId2Enum[cmbLML2_TX_PRE] = LMS7002MCSR::LML2_BB2RF_PRE;
    wndId2Enum[cmbLML2_TX_PST] = LMS7002MCSR::LML2_BB2RF_PST;
    wndId2Enum[rgrLML_MODE1] = LMS7002MCSR::LML1_MODE;
    wndId2Enum[rgrLML_MODE2] = LMS7002MCSR::LML2_MODE;
    wndId2Enum[rgrLML_TXNRXIQ1] = LMS7002MCSR::LML1_TXNRXIQ;
    wndId2Enum[rgrLML_TXNRXIQ2] = LMS7002MCSR::LML2_TXNRXIQ;
    wndId2Enum[chkLRST_RX_A] = LMS7002MCSR::LRST_RX_A;
    wndId2Enum[chkLRST_RX_B] = LMS7002MCSR::LRST_RX_B;
    wndId2Enum[chkLRST_TX_A] = LMS7002MCSR::LRST_TX_A;
    wndId2Enum[chkLRST_TX_B] = LMS7002MCSR::LRST_TX_B;
    wndId2Enum[cmbMCLK1SRC] = LMS7002MCSR::MCLK1SRC;
    wndId2Enum[cmbRXTSPCLKA_DIV] = LMS7002MCSR::RXTSPCLKA_DIV;
    wndId2Enum[chkMCLK1_PE] = LMS7002MCSR::MCLK1_PE;
    wndId2Enum[cmbMCLK2SRC] = LMS7002MCSR::MCLK2SRC;
    wndId2Enum[cmbTXTSPCLKA_DIV] = LMS7002MCSR::TXTSPCLKA_DIV;
    wndId2Enum[chkMCLK2_PE] = LMS7002MCSR::MCLK2_PE;
    wndId2Enum[chkMIMO_SISO] = LMS7002MCSR::MIMO_SISO;
    wndId2Enum[chkMOD_EN] = LMS7002MCSR::MOD_EN;
    wndId2Enum[chkMRST_RX_A] = LMS7002MCSR::MRST_RX_A;
    wndId2Enum[chkMRST_RX_B] = LMS7002MCSR::MRST_RX_B;
    wndId2Enum[chkMRST_TX_A] = LMS7002MCSR::MRST_TX_A;
    wndId2Enum[chkMRST_TX_B] = LMS7002MCSR::MRST_TX_B;
    wndId2Enum[chkRXDIVEN] = LMS7002MCSR::RXDIVEN;
    wndId2Enum[chkRXEN_A] = LMS7002MCSR::RXEN_A;
    wndId2Enum[chkRXEN_B] = LMS7002MCSR::RXEN_B;
    wndId2Enum[cmbRXRDCLK_MUX] = LMS7002MCSR::RXRDCLK_MUX;
    wndId2Enum[cmbRXWRCLK_MUX] = LMS7002MCSR::RXWRCLK_MUX;
    wndId2Enum[chkRX_CLK_PE] = LMS7002MCSR::RX_CLK_PE;
    wndId2Enum[chkSCLK_PE] = LMS7002MCSR::SCLK_PE;
    wndId2Enum[rgrSCL_DS] = LMS7002MCSR::SCL_DS;
    wndId2Enum[chkSCL_PE] = LMS7002MCSR::SCL_PE;
    wndId2Enum[rgrSDA_DS] = LMS7002MCSR::SDA_DS;
    wndId2Enum[chkSDA_PE] = LMS7002MCSR::SDA_PE;
    wndId2Enum[rgrSDIO_DS] = LMS7002MCSR::SDIO_DS;
    wndId2Enum[chkSDIO_PE] = LMS7002MCSR::SDIO_PE;
    wndId2Enum[chkSDO_PE] = LMS7002MCSR::SDO_PE;
    wndId2Enum[chkSEN_PE] = LMS7002MCSR::SEN_PE;
    wndId2Enum[rgrSPIMODE] = LMS7002MCSR::SPIMODE;
    wndId2Enum[chkSRST_RXFIFO] = LMS7002MCSR::SRST_RXFIFO;
    wndId2Enum[chkSRST_TXFIFO] = LMS7002MCSR::SRST_TXFIFO;
    wndId2Enum[chkTXDIVEN] = LMS7002MCSR::TXDIVEN;
    wndId2Enum[chkTXEN_A] = LMS7002MCSR::TXEN_A;
    wndId2Enum[chkTXEN_B] = LMS7002MCSR::TXEN_B;
    wndId2Enum[rgrTX_MUX] = LMS7002MCSR::TX_MUX;
    wndId2Enum[chkTXNRX1_PE] = LMS7002MCSR::TXNRX1_PE;
    wndId2Enum[chkTXNRX2_PE] = LMS7002MCSR::TXNRX2_PE;
    wndId2Enum[cmbTXRDCLK_MUX] = LMS7002MCSR::TXRDCLK_MUX;
    wndId2Enum[cmbTXWRCLK_MUX] = LMS7002MCSR::TXWRCLK_MUX;
    wndId2Enum[chkTX_CLK_PE] = LMS7002MCSR::TX_CLK_PE;
    wndId2Enum[rgrLML_FIDM1] = LMS7002MCSR::LML1_FIDM;
    wndId2Enum[rgrLML_FIDM2] = LMS7002MCSR::LML2_FIDM;
    wndId2Enum[chkFCLK1_INV] = LMS7002MCSR::FCLK1_INV;
    wndId2Enum[chkFCLK2_INV] = LMS7002MCSR::FCLK2_INV;
    wndId2Enum[rgrDIQDIRCTR2] = LMS7002MCSR::DIQDIRCTR2;
    wndId2Enum[rgrDIQDIR2] = LMS7002MCSR::DIQDIR2;
    wndId2Enum[rgrDIQDIRCTR1] = LMS7002MCSR::DIQDIRCTR1;
    wndId2Enum[rgrDIQDIR1] = LMS7002MCSR::DIQDIR1;
    wndId2Enum[rgrENABLEDIRCTR2] = LMS7002MCSR::ENABLEDIRCTR2;
    wndId2Enum[rgrENABLEDIR2] = LMS7002MCSR::ENABLEDIR2;
    wndId2Enum[rgrENABLEDIRCTR1] = LMS7002MCSR::ENABLEDIRCTR1;
    wndId2Enum[rgrENABLEDIR1] = LMS7002MCSR::ENABLEDIR1;
    wndId2Enum[chkMCLK1_INV] = LMS7002MCSR::MCLK1_INV;
    wndId2Enum[chkMCLK2_INV] = LMS7002MCSR::MCLK2_INV;
    wndId2Enum[cmbFCLK1_DLY] = LMS7002MCSR::FCLK1_DLY;
    wndId2Enum[cmbFCLK2_DLY] = LMS7002MCSR::FCLK2_DLY;
    wndId2Enum[cmbMCLK1_DLY] = LMS7002MCSR::MCLK1_DLY;
    wndId2Enum[cmbMCLK2_DLY] = LMS7002MCSR::MCLK2_DLY;
    wndId2Enum[chkLML1_TRXIQPULSE] = LMS7002MCSR::LML1_TRXIQPULSE;
    wndId2Enum[chkLML2_TRXIQPULSE] = LMS7002MCSR::LML2_TRXIQPULSE;
    wndId2Enum[chkLML1_SISODDR] = LMS7002MCSR::LML1_SISODDR;
    wndId2Enum[chkLML2_SISODDR] = LMS7002MCSR::LML2_SISODDR;
...
void lms7002_pnlLimeLightPAD_view::SpinParameterChangeHandler(wxSpinEvent& event)
{
    wxCommandEvent evt;
...
void lms7002_pnlLimeLightPAD_view::onbtnReadVerRevMask(wxCommandEvent& event)
{
    ...
    value = ReadParam(LMS7002MCSR::VER);
    lblVER->SetLabel(std::to_string(value));

    value = ReadParam(LMS7002MCSR::REV);
