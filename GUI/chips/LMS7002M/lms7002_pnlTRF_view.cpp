    ...
    : ILMS7002MTab(parent, id, pos, size, style)
{
    ...
    wndId2Enum[chkEN_LOOPB_TXPAD_TRF] = LMS7002MCSR::EN_LOOPB_TXPAD_TRF;
    wndId2Enum[cmbEN_LOWBWLOMX_TMX_TRF] = LMS7002MCSR::EN_LOWBWLOMX_TMX_TRF;
    wndId2Enum[chkEN_NEXTTX_TRF] = LMS7002MCSR::EN_NEXTTX_TRF;
    wndId2Enum[cmbF_TXPAD_TRF] = LMS7002MCSR::F_TXPAD_TRF;
    wndId2Enum[rgrGCAS_GNDREF_TXPAD_TRF] = LMS7002MCSR::GCAS_GNDREF_TXPAD_TRF;
    wndId2Enum[cmbICT_LIN_TXPAD_TRF] = LMS7002MCSR::ICT_LIN_TXPAD_TRF;
    wndId2Enum[cmbICT_MAIN_TXPAD_TRF] = LMS7002MCSR::ICT_MAIN_TXPAD_TRF;
    wndId2Enum[cmbLOADR_PDET_TRF] = LMS7002MCSR::LOADR_PDET_TRF;
    wndId2Enum[cmbLOBIASN_TXM_TRF] = LMS7002MCSR::LOBIASN_TXM_TRF;
    wndId2Enum[cmbLOBIASP_TXX_TRF] = LMS7002MCSR::LOBIASP_TXX_TRF;
    wndId2Enum[cmbLOSS_LIN_TXPAD_TRF] = LMS7002MCSR::LOSS_LIN_TXPAD_TRF;
    wndId2Enum[cmbLOSS_MAIN_TXPAD_TRF] = LMS7002MCSR::LOSS_MAIN_TXPAD_TRF;
    wndId2Enum[cmbL_LOOPB_TXPAD_TRF] = LMS7002MCSR::L_LOOPB_TXPAD_TRF;
    wndId2Enum[chkPD_PDET_TRF] = LMS7002MCSR::PD_PDET_TRF;
    wndId2Enum[chkPD_TLOBUF_TRF] = LMS7002MCSR::PD_TLOBUF_TRF;
    wndId2Enum[chkPD_TXPAD_TRF] = LMS7002MCSR::PD_TXPAD_TRF;
    wndId2Enum[cmbVGCAS_TXPAD_TRF] = LMS7002MCSR::VGCAS_TXPAD_TRF;
    wndId2Enum[cmbCDC_I_TRF] = LMS7002MCSR::CDC_I_TRF;
    wndId2Enum[cmbCDC_Q_TRF] = LMS7002MCSR::CDC_Q_TRF;
    wndId2Enum[chkEN_DIR_TRF] = LMS7002MCSR::EN_DIR_TRF;
...
void lms7002_pnlTRF_view::OnBandChange(wxCommandEvent& event)
{
    ...
    {
    case 0:
        WriteParam(LMS7002MCSR::SEL_BAND1_TRF, true);
        WriteParam(LMS7002MCSR::SEL_BAND2_TRF, false);
        break;
    case 1:
        WriteParam(LMS7002MCSR::SEL_BAND1_TRF, false);
        WriteParam(LMS7002MCSR::SEL_BAND2_TRF, true);
        break;
    case 2:
        WriteParam(LMS7002MCSR::SEL_BAND1_TRF, false);
        WriteParam(LMS7002MCSR::SEL_BAND2_TRF, false);
...
void lms7002_pnlTRF_view::UpdateGUI()
{
    ...
    uint16_t value;
    value = ReadParam(LMS7002MCSR::EN_AMPHF_PDET_TRF);
    cmbEN_AMPHF_PDET_TRF->SetSelection(value2index(value, en_amphf_pdet_trfIndexValuePairs));

    uint16_t SEL_BAND1_TRFvalue;
    SEL_BAND1_TRFvalue = ReadParam(LMS7002MCSR::SEL_BAND1_TRF);
    uint16_t SEL_BAND2_TRFvalue;
    SEL_BAND2_TRFvalue = ReadParam(LMS7002MCSR::SEL_BAND2_TRF);
