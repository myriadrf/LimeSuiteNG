    ...
    : ILMS7002MTab(parent, id, pos, size, style)
{
    ...
    ID_PANEL3 = new wxPanel(ID_NOTEBOOK1, wxID_ANY);
    ...
    chkEN_G_LDOP = new wxCheckBox(
        sbSizer46->GetStaticBox(), ID_EN_G_LDOP, wxT("Enable LDO digital module"), wxDefaultPosition, wxDefaultSize, 0);
    chkEN_G_LDOP->SetToolTip(wxT("Enable control for all the LDO power downs"));

    fgSizer70->Add(chkEN_G_LDOP, 0, flags, 0);

    chkEN_G_LDO = new wxCheckBox(
        sbSizer46->GetStaticBox(), ID_EN_G_LDO, wxT("Enable LDO analog module"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkEN_LDO_DIVGN =
        new wxCheckBox(sbSizer47->GetStaticBox(), ID_EN_LDO_DIVGN, wxT("EN_LDO_DIVGN"), wxDefaultPosition, wxDefaultSize, 0);
    chkEN_LDO_DIVGN->SetToolTip(wxT("Enables the LDO"));

    sbSizer47->Add(chkEN_LDO_DIVGN, 0, flags, 0);

    chkEN_LDO_DIGGN =
        new wxCheckBox(sbSizer47->GetStaticBox(), ID_EN_LDO_DIGGN, wxT("EN_LDO_DIGGN"), wxDefaultPosition, wxDefaultSize, 0);
    chkEN_LDO_DIGGN->SetToolTip(wxT("Enables the LDO"));

    sbSizer47->Add(chkEN_LDO_DIGGN, 0, flags, 0);

    chkEN_LDO_CPGN =
        new wxCheckBox(sbSizer47->GetStaticBox(), ID_EN_LDO_CPGN, wxT("EN_LDO_CPGN"), wxDefaultPosition, wxDefaultSize, 0);
    chkEN_LDO_CPGN->SetToolTip(wxT("Enables the LDO"));

    sbSizer47->Add(chkEN_LDO_CPGN, 0, flags, 0);

    chkEN_LDO_VCOGN =
        new wxCheckBox(sbSizer47->GetStaticBox(), ID_EN_LDO_VCOGN, wxT("EN_LDO_VCOGN"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkEN_LDO_MXRFE =
        new wxCheckBox(sbSizer48->GetStaticBox(), ID_EN_LDO_MXRFE, wxT("EN_LDO_MXRFE"), wxDefaultPosition, wxDefaultSize, 0);
    chkEN_LDO_MXRFE->SetToolTip(wxT("Enables the LDO"));

    sbSizer48->Add(chkEN_LDO_MXRFE, 0, flags, 0);

    chkEN_LDO_LNA14 =
        new wxCheckBox(sbSizer48->GetStaticBox(), ID_EN_LDO_LNA14, wxT("EN_LDO_LNA14"), wxDefaultPosition, wxDefaultSize, 0);
    chkEN_LDO_LNA14->SetToolTip(wxT("Enables the LDO"));

    sbSizer48->Add(chkEN_LDO_LNA14, 0, flags, 0);

    chkEN_LDO_LNA12 =
        new wxCheckBox(sbSizer48->GetStaticBox(), ID_EN_LDO_LNA12, wxT("EN_LDO_LNA12"), wxDefaultPosition, wxDefaultSize, 0);
    chkEN_LDO_LNA12->SetToolTip(wxT("Enables the LDO"));

    sbSizer48->Add(chkEN_LDO_LNA12, 0, flags, 0);

    chkEN_LDO_TIA14 =
        new wxCheckBox(sbSizer48->GetStaticBox(), ID_EN_LDO_TIA14, wxT("EN_LDO_TIA14"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkEN_LDO_DIVSXT =
        new wxCheckBox(sbSizer49->GetStaticBox(), ID_EN_LDO_DIVSXT, wxT("EN_LDO_DIVSXT"), wxDefaultPosition, wxDefaultSize, 0);
    chkEN_LDO_DIVSXT->SetToolTip(wxT("Enables the LDO"));

    sbSizer49->Add(chkEN_LDO_DIVSXT, 0, flags, 0);

    chkEN_LDO_DIGSXT =
        new wxCheckBox(sbSizer49->GetStaticBox(), ID_EN_LDO_DIGSXT, wxT("EN_LDO_DIGSXT"), wxDefaultPosition, wxDefaultSize, 0);
    chkEN_LDO_DIGSXT->SetToolTip(wxT("Enables the LDO"));

    sbSizer49->Add(chkEN_LDO_DIGSXT, 0, flags, 0);

    chkEN_LDO_CPSXT =
        new wxCheckBox(sbSizer49->GetStaticBox(), ID_EN_LDO_CPSXT, wxT("EN_LDO_CPSXT"), wxDefaultPosition, wxDefaultSize, 0);
    chkEN_LDO_CPSXT->SetToolTip(wxT("Enables the LDO"));

    sbSizer49->Add(chkEN_LDO_CPSXT, 0, flags, 0);

    chkEN_LDO_VCOSXT =
        new wxCheckBox(sbSizer49->GetStaticBox(), ID_EN_LDO_VCOSXT, wxT("EN_LDO_VCOSXT"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkEN_LDO_DIVSXR =
        new wxCheckBox(sbSizer50->GetStaticBox(), ID_EN_LDO_DIVSXR, wxT("EN_LDO_DIVSXR"), wxDefaultPosition, wxDefaultSize, 0);
    chkEN_LDO_DIVSXR->SetToolTip(wxT("Enables the LDO"));

    sbSizer50->Add(chkEN_LDO_DIVSXR, 0, flags, 0);

    chkEN_LDO_DIGSXR =
        new wxCheckBox(sbSizer50->GetStaticBox(), ID_EN_LDO_DIGSXR, wxT("EN_LDO_DIGSXR"), wxDefaultPosition, wxDefaultSize, 0);
    chkEN_LDO_DIGSXR->SetToolTip(wxT("Enables the LDO"));

    sbSizer50->Add(chkEN_LDO_DIGSXR, 0, flags, 0);

    chkEN_LDO_CPSXR =
        new wxCheckBox(sbSizer50->GetStaticBox(), ID_EN_LDO_CPSXR, wxT("EN_LDO_CPSXR"), wxDefaultPosition, wxDefaultSize, 0);
    chkEN_LDO_CPSXR->SetToolTip(wxT("Enables the LDO"));

    sbSizer50->Add(chkEN_LDO_CPSXR, 0, flags, 0);

    chkEN_LDO_VCOSXR =
        new wxCheckBox(sbSizer50->GetStaticBox(), ID_EN_LDO_VCOSXR, wxT("EN_LDO_VCOSXR"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkPD_LDO_DIGIp1 =
        new wxCheckBox(sbSizer51->GetStaticBox(), ID_PD_LDO_DIGIp1, wxT("PD_LDO_DIGIp1"), wxDefaultPosition, wxDefaultSize, 0);
    chkPD_LDO_DIGIp1->SetToolTip(wxT("Enables the LDO"));

    sbSizer51->Add(chkPD_LDO_DIGIp1, 0, flags, 0);

    chkPD_LDO_DIGIp2 =
        new wxCheckBox(sbSizer51->GetStaticBox(), ID_PD_LDO_DIGIp2, wxT("PD_LDO_DIGIp2"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkEN_LDO_TXBUF =
        new wxCheckBox(sbSizer52->GetStaticBox(), ID_EN_LDO_TXBUF, wxT("EN_LDO_TXBUF"), wxDefaultPosition, wxDefaultSize, 0);
    chkEN_LDO_TXBUF->SetToolTip(wxT("Enables the LDO"));

    sbSizer52->Add(chkEN_LDO_TXBUF, 0, flags, 0);

    chkEN_LDO_RXBUF =
        new wxCheckBox(sbSizer52->GetStaticBox(), ID_EN_LDO_RXBUF, wxT("EN_LDO_RXBUF"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkEN_LDO_TPAD =
        new wxCheckBox(sbSizer58->GetStaticBox(), ID_EN_LDO_TPAD, wxT("EN_LDO_TPAD"), wxDefaultPosition, wxDefaultSize, 0);
    chkEN_LDO_TPAD->SetToolTip(wxT("Enables the LDO"));

    sbSizer58->Add(chkEN_LDO_TPAD, 0, flags, 0);

    chkEN_LDO_TLOB =
        new wxCheckBox(sbSizer58->GetStaticBox(), ID_EN_LDO_TLOB, wxT("EN_LDO_TLOB"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    sbSizer54 =
        new wxStaticBoxSizer(new wxStaticBox(sbSizer46->GetStaticBox(), wxID_ANY, wxT("SPI Buffer to analog blocks")), wxVERTICAL);

    chkPD_LDO_SPIBUF =
        new wxCheckBox(sbSizer54->GetStaticBox(), ID_PD_LDO_SPIBUF, wxT("PD_LDO_SPIBUF"), wxDefaultPosition, wxDefaultSize, 0);
    chkPD_LDO_SPIBUF->SetToolTip(wxT("Enables the LDO"));

    sbSizer54->Add(chkPD_LDO_SPIBUF, 0, wxEXPAND, 0);

    wxFlexGridSizer* fgSizer251;
    fgSizer251 = new wxFlexGridSizer(0, 2, 0, 5);
    fgSizer251->SetFlexibleDirection(wxBOTH);
    fgSizer251->SetNonFlexibleGrowMode(wxFLEX_GROWMODE_SPECIFIED);

    m_staticText349 =
        new wxStaticText(sbSizer54->GetStaticBox(), wxID_ANY, wxT("ISINK_SPI_BUFF"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkEN_LDO_AFE =
        new wxCheckBox(sbSizer53->GetStaticBox(), ID_EN_LDO_AFE, wxT("EN_LDO_AFE"), wxDefaultPosition, wxDefaultSize, 0);
    chkEN_LDO_AFE->SetToolTip(wxT("Enables the LDO"));

    sbSizer53->Add(chkEN_LDO_AFE, 0, flags, 0);

    fgSizer70->Add(sbSizer53, 1, wxEXPAND, 0);
    ...
    chkEN_LDO_TBB =
        new wxCheckBox(sbSizer55->GetStaticBox(), ID_EN_LDO_TBB, wxT("EN_LDO_TBB"), wxDefaultPosition, wxDefaultSize, 0);
    chkEN_LDO_TBB->SetToolTip(wxT("Enables the LDO"));

    sbSizer55->Add(chkEN_LDO_TBB, 0, wxALIGN_CENTER_HORIZONTAL | wxALIGN_TOP, 0);

    fgSizer70->Add(sbSizer55, 1, wxEXPAND, 5);
    ...
    chkEN_LDO_RBB =
        new wxCheckBox(sbSizer56->GetStaticBox(), ID_EN_LDO_RBB, wxT("EN_LDO_RBB"), wxDefaultPosition, wxDefaultSize, 0);
    chkEN_LDO_RBB->SetToolTip(wxT("Enables the LDO"));

    sbSizer56->Add(chkEN_LDO_RBB, 0, wxALIGN_CENTER_HORIZONTAL | wxALIGN_TOP, 0);

    fgSizer70->Add(sbSizer56, 1, wxEXPAND, 5);
    ...
    chkEN_LDO_TIA12 =
        new wxCheckBox(sbSizer57->GetStaticBox(), ID_EN_LDO_TIA12, wxT("EN_LDO_TIA12"), wxDefaultPosition, wxDefaultSize, 0);
    chkEN_LDO_TIA12->SetToolTip(wxT("Enables the LDO"));

    sbSizer57->Add(chkEN_LDO_TIA12, 0, wxALIGN_CENTER_HORIZONTAL | wxALIGN_TOP, 0);

    fgSizer70->Add(sbSizer57, 1, wxEXPAND, 5);
    ...
    chkEN_LDO_DIG =
        new wxCheckBox(sbSizer59->GetStaticBox(), ID_EN_LDO_DIG, wxT("EN_LDO_DIG"), wxDefaultPosition, wxDefaultSize, 0);
    chkEN_LDO_DIG->SetToolTip(wxT("Enables the LDO"));

    sbSizer59->Add(chkEN_LDO_DIG, 0, wxALIGN_CENTER_HORIZONTAL | wxALIGN_TOP, 0);

    fgSizer70->Add(sbSizer59, 1, wxEXPAND, 5);
    ...
    chkSPDUP_LDO_TBB =
        new wxCheckBox(sbSizer61->GetStaticBox(), ID_SPDUP_LDO_TBB, wxT("SPDUP_LDO_TBB"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkSPDUP_LDO_TIA12 =
        new wxCheckBox(sbSizer61->GetStaticBox(), ID_SPDUP_LDO_TIA12, wxT("SPDUP_LDO_TIA12"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkSPDUP_LDO_TIA14 =
        new wxCheckBox(sbSizer61->GetStaticBox(), ID_SPDUP_LDO_TIA14, wxT("SPDUP_LDO_TIA14"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkSPDUP_LDO_TLOB =
        new wxCheckBox(sbSizer61->GetStaticBox(), ID_SPDUP_LDO_TLOB, wxT("SPDUP_LDO_TLOB"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkSPDUP_LDO_TPAD =
        new wxCheckBox(sbSizer61->GetStaticBox(), ID_SPDUP_LDO_TPAD, wxT("SPDUP_LDO_TPAD"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkSPDUP_LDO_TXBUF =
        new wxCheckBox(sbSizer61->GetStaticBox(), ID_SPDUP_LDO_TXBUF, wxT("SPDUP_LDO_TXBUF"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkSPDUP_LDO_VCOGN =
        new wxCheckBox(sbSizer61->GetStaticBox(), ID_SPDUP_LDO_VCOGN, wxT("SPDUP_LDO_VCOGN"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkSPDUP_LDO_DIVSXR = new wxCheckBox(
        sbSizer61->GetStaticBox(), ID_SPDUP_LDO_DIVSXR, wxT("SPDUP_LDO_DIVSXR"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkSPDUP_LDO_DIVSXT = new wxCheckBox(
        sbSizer61->GetStaticBox(), ID_SPDUP_LDO_DIVSXT, wxT("SPDUP_LDO_DIVSXT"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkSPDUP_LDO_AFE =
        new wxCheckBox(sbSizer61->GetStaticBox(), ID_SPDUP_LDO_AFE, wxT("SPDUP_LDO_AFE"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkSPDUP_LDO_CPGN =
        new wxCheckBox(sbSizer61->GetStaticBox(), ID_SPDUP_LDO_CPGN, wxT("SPDUP_LDO_CPGN"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkSPDUP_LDO_VCOSXR = new wxCheckBox(
        sbSizer61->GetStaticBox(), ID_SPDUP_LDO_VCOSXR, wxT("SPDUP_LDO_VCOSXR"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkSPDUP_LDO_VCOSXT = new wxCheckBox(
        sbSizer61->GetStaticBox(), ID_SPDUP_LDO_VCOSXT, wxT("SPDUP_LDO_VCOSXT"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkSPDUP_LDO_DIG =
        new wxCheckBox(sbSizer61->GetStaticBox(), ID_SPDUP_LDO_DIG, wxT("SPDUP_LDO_DIG"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkSPDUP_LDO_DIGGN =
        new wxCheckBox(sbSizer61->GetStaticBox(), ID_SPDUP_LDO_DIGGN, wxT("SPDUP_LDO_DIGGN"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkSPDUP_LDO_DIGSXR = new wxCheckBox(
        sbSizer61->GetStaticBox(), ID_SPDUP_LDO_DIGSXR, wxT("SPDUP_LDO_DIGSXR"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkSPDUP_LDO_DIGSXT = new wxCheckBox(
        sbSizer61->GetStaticBox(), ID_SPDUP_LDO_DIGSXT, wxT("SPDUP_LDO_DIGSXT"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkSPDUP_LDO_DIVGN =
        new wxCheckBox(sbSizer61->GetStaticBox(), ID_SPDUP_LDO_DIVGN, wxT("SPDUP_LDO_DIVGN"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkSPDUP_LDO_CPSXR =
        new wxCheckBox(sbSizer61->GetStaticBox(), ID_SPDUP_LDO_CPSXR, wxT("SPDUP_LDO_CPSXR"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkSPDUP_LDO_CPSXT =
        new wxCheckBox(sbSizer61->GetStaticBox(), ID_SPDUP_LDO_CPSXT, wxT("SPDUP_LDO_CPSXT"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkSPDUP_LDO_LNA12 =
        new wxCheckBox(sbSizer61->GetStaticBox(), ID_SPDUP_LDO_LNA12, wxT("SPDUP_LDO_LNA12"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkSPDUP_LDO_LNA14 =
        new wxCheckBox(sbSizer61->GetStaticBox(), ID_SPDUP_LDO_LNA14, wxT("SPDUP_LDO_LNA14"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkSPDUP_LDO_MXRFE =
        new wxCheckBox(sbSizer61->GetStaticBox(), ID_SPDUP_LDO_MXRFE, wxT("SPDUP_LDO_MXRFE"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkSPDUP_LDO_RBB =
        new wxCheckBox(sbSizer61->GetStaticBox(), ID_SPDUP_LDO_RBB, wxT("SPDUP_LDO_RBB"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkSPDUP_LDO_RXBUF =
        new wxCheckBox(sbSizer61->GetStaticBox(), ID_SPDUP_LDO_RXBUF, wxT("SPDUP_LDO_RXBUF"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkSPDUP_LDO_SPIBUF = new wxCheckBox(
        sbSizer61->GetStaticBox(), ID_SPDUP_LDO_SPIBUF, wxT("SPDUP_LDO_SPIBUF"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkSPDUP_LDO_DIGIp2 = new wxCheckBox(
        sbSizer61->GetStaticBox(), ID_SPDUP_LDO_DIGIp2, wxT("SPDUP_LDO_DIGIp2"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkSPDUP_LDO_DIGIp1 = new wxCheckBox(
        sbSizer61->GetStaticBox(), ID_SPDUP_LDO_DIGIp1, wxT("SPDUP_LDO_DIGIp1"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkEN_LOADIMP_LDO_TBB = new wxCheckBox(
        sbSizer62->GetStaticBox(), ID_EN_LOADIMP_LDO_TBB, wxT("EN_LOADIMP_LDO_TBB"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkEN_LOADIMP_LDO_TIA12 = new wxCheckBox(
        sbSizer62->GetStaticBox(), ID_EN_LOADIMP_LDO_TIA12, wxT("EN_LOADIMP_LDO_TIA12"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkEN_LOADIMP_LDO_TIA14 = new wxCheckBox(
        sbSizer62->GetStaticBox(), ID_EN_LOADIMP_LDO_TIA14, wxT("EN_LOADIMP_LDO_TIA14"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkEN_LOADIMP_LDO_TLOB = new wxCheckBox(
        sbSizer62->GetStaticBox(), ID_EN_LOADIMP_LDO_TLOB, wxT("EN_LOADIMP_LDO_TLOB"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkEN_LOADIMP_LDO_TPAD = new wxCheckBox(
        sbSizer62->GetStaticBox(), ID_EN_LOADIMP_LDO_TPAD, wxT("EN_LOADIMP_LDO_TPAD"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkEN_LOADIMP_LDO_TXBUF = new wxCheckBox(
        sbSizer62->GetStaticBox(), ID_EN_LOADIMP_LDO_TXBUF, wxT("EN_LOADIMP_LDO_TXBUF"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkEN_LOADIMP_LDO_VCOGN = new wxCheckBox(
        sbSizer62->GetStaticBox(), ID_EN_LOADIMP_LDO_VCOGN, wxT("EN_LOADIMP_LDO_VCOGN"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkEN_LOADIMP_LDO_VCOSXR = new wxCheckBox(
        sbSizer62->GetStaticBox(), ID_EN_LOADIMP_LDO_VCOSXR, wxT("EN_LOADIMP_LDO_VCOSXR"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkEN_LOADIMP_LDO_VCOSXT = new wxCheckBox(
        sbSizer62->GetStaticBox(), ID_EN_LOADIMP_LDO_VCOSXT, wxT("EN_LOADIMP_LDO_VCOSXT"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkEN_LOADIMP_LDO_AFE = new wxCheckBox(
        sbSizer62->GetStaticBox(), ID_EN_LOADIMP_LDO_AFE, wxT("EN_LOADIMP_LDO_AFE"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkEN_LOADIMP_LDO_CPGN = new wxCheckBox(
        sbSizer62->GetStaticBox(), ID_EN_LOADIMP_LDO_CPGN, wxT("EN_LOADIMP_LDO_CPGN"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkEN_LOADIMP_LDO_DIVSXR = new wxCheckBox(
        sbSizer62->GetStaticBox(), ID_EN_LOADIMP_LDO_DIVSXR, wxT("EN_LOADIMP_LDO_DIVSXR"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkEN_LOADIMP_LDO_DIVSXT = new wxCheckBox(
        sbSizer62->GetStaticBox(), ID_EN_LOADIMP_LDO_DIVSXT, wxT("EN_LOADIMP_LDO_DIVSXT"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkEN_LOADIMP_LDO_DIG = new wxCheckBox(
        sbSizer62->GetStaticBox(), ID_EN_LOADIMP_LDO_DIG, wxT("EN_LOADIMP_LDO_DIG"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkEN_LOADIMP_LDO_DIGGN = new wxCheckBox(
        sbSizer62->GetStaticBox(), ID_EN_LOADIMP_LDO_DIGGN, wxT("EN_LOADIMP_LDO_DIGGN"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkEN_LOADIMP_LDO_DIGSXR = new wxCheckBox(
        sbSizer62->GetStaticBox(), ID_EN_LOADIMP_LDO_DIGSXR, wxT("EN_LOADIMP_LDO_DIGSXR"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkEN_LOADIMP_LDO_DIGSXT = new wxCheckBox(
        sbSizer62->GetStaticBox(), ID_EN_LOADIMP_LDO_DIGSXT, wxT("EN_LOADIMP_LDO_DIGSXT"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkEN_LOADIMP_LDO_DIVGN = new wxCheckBox(
        sbSizer62->GetStaticBox(), ID_EN_LOADIMP_LDO_DIVGN, wxT("EN_LOADIMP_LDO_DIVGN"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkEN_LOADIMP_LDO_CPSXR = new wxCheckBox(
        sbSizer62->GetStaticBox(), ID_EN_LOADIMP_LDO_CPSXR, wxT("EN_LOADIMP_LDO_CPSXR"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkEN_LOADIMP_LDO_CPSXT = new wxCheckBox(
        sbSizer62->GetStaticBox(), ID_EN_LOADIMP_LDO_CPSXT, wxT("EN_LOADIMP_LDO_CPSXT"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkEN_LOADIMP_LDO_LNA12 = new wxCheckBox(
        sbSizer62->GetStaticBox(), ID_EN_LOADIMP_LDO_LNA12, wxT("EN_LOADIMP_LDO_LNA12"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkEN_LOADIMP_LDO_LNA14 = new wxCheckBox(
        sbSizer62->GetStaticBox(), ID_EN_LOADIMP_LDO_LNA14, wxT("EN_LOADIMP_LDO_LNA14"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkEN_LOADIMP_LDO_MXRFE = new wxCheckBox(
        sbSizer62->GetStaticBox(), ID_EN_LOADIMP_LDO_MXRFE, wxT("EN_LOADIMP_LDO_MXRFE"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkEN_LOADIMP_LDO_RBB = new wxCheckBox(
        sbSizer62->GetStaticBox(), ID_EN_LOADIMP_LDO_RBB, wxT("EN_LOADIMP_LDO_RBB"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkEN_LOADIMP_LDO_RXBUF = new wxCheckBox(
        sbSizer62->GetStaticBox(), ID_EN_LOADIMP_LDO_RXBUF, wxT("EN_LOADIMP_LDO_RXBUF"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkEN_LOADIMP_LDO_SPIBUF = new wxCheckBox(
        sbSizer62->GetStaticBox(), ID_EN_LOADIMP_LDO_SPIBUF, wxT("EN_LOADIMP_LDO_SPIBUF"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkEN_LOADIMP_LDO_DIGIp2 = new wxCheckBox(
        sbSizer62->GetStaticBox(), ID_EN_LOADIMP_LDO_DIGIp2, wxT("EN_LOADIMP_LDO_DIGIp2"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkEN_LOADIMP_LDO_DIGIp1 = new wxCheckBox(
        sbSizer62->GetStaticBox(), ID_EN_LOADIMP_LDO_DIGIp1, wxT("EN_LOADIMP_LDO_DIGIp1"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    ID_PANEL2->SetSizerAndFit(fgSizer75);
    // ID_PANEL2->Layout();
    ...
    wndId2Enum[chkEN_G_LDO] = LMS7002MCSR::EN_G_LDO;
    wndId2Enum[chkEN_G_LDOP] = LMS7002MCSR::EN_G_LDOP;
    wndId2Enum[chkEN_LDO_AFE] = LMS7002MCSR::EN_LDO_AFE;
    wndId2Enum[chkEN_LDO_CPGN] = LMS7002MCSR::EN_LDO_CPGN;
    wndId2Enum[chkEN_LDO_CPSXR] = LMS7002MCSR::EN_LDO_CPSXR;
    wndId2Enum[chkEN_LDO_CPSXT] = LMS7002MCSR::EN_LDO_CPSXT;
    wndId2Enum[chkEN_LDO_DIG] = LMS7002MCSR::EN_LDO_DIG;
    wndId2Enum[chkEN_LDO_DIGGN] = LMS7002MCSR::EN_LDO_DIGGN;
    wndId2Enum[chkPD_LDO_DIGIp1] = LMS7002MCSR::PD_LDO_DIGIp1;
    wndId2Enum[chkPD_LDO_DIGIp2] = LMS7002MCSR::PD_LDO_DIGIp2;
    wndId2Enum[chkEN_LDO_DIGSXR] = LMS7002MCSR::EN_LDO_DIGSXR;
    wndId2Enum[chkEN_LDO_DIGSXT] = LMS7002MCSR::EN_LDO_DIGSXT;
    wndId2Enum[chkEN_LDO_DIVGN] = LMS7002MCSR::EN_LDO_DIVGN;
    wndId2Enum[chkEN_LDO_DIVSXR] = LMS7002MCSR::EN_LDO_DIVSXR;
    wndId2Enum[chkEN_LDO_DIVSXT] = LMS7002MCSR::EN_LDO_DIVSXT;
    wndId2Enum[chkEN_LDO_LNA12] = LMS7002MCSR::EN_LDO_LNA12;
    wndId2Enum[chkEN_LDO_LNA14] = LMS7002MCSR::EN_LDO_LNA14;
    wndId2Enum[chkEN_LDO_MXRFE] = LMS7002MCSR::EN_LDO_MXRFE;
    wndId2Enum[chkEN_LDO_RBB] = LMS7002MCSR::EN_LDO_RBB;
    wndId2Enum[chkEN_LDO_RXBUF] = LMS7002MCSR::EN_LDO_RXBUF;
    wndId2Enum[chkPD_LDO_SPIBUF] = LMS7002MCSR::PD_LDO_SPIBUF;
    wndId2Enum[chkEN_LDO_TBB] = LMS7002MCSR::EN_LDO_TBB;
    wndId2Enum[chkEN_LDO_TIA12] = LMS7002MCSR::EN_LDO_TIA12;
    wndId2Enum[chkEN_LDO_TIA14] = LMS7002MCSR::EN_LDO_TIA14;
    wndId2Enum[chkEN_LDO_TLOB] = LMS7002MCSR::EN_LDO_TLOB;
    wndId2Enum[chkEN_LDO_TPAD] = LMS7002MCSR::EN_LDO_TPAD;
    wndId2Enum[chkEN_LDO_TXBUF] = LMS7002MCSR::EN_LDO_TXBUF;
    wndId2Enum[chkEN_LDO_VCOGN] = LMS7002MCSR::EN_LDO_VCOGN;
    wndId2Enum[chkEN_LDO_VCOSXR] = LMS7002MCSR::EN_LDO_VCOSXR;
    wndId2Enum[chkEN_LDO_VCOSXT] = LMS7002MCSR::EN_LDO_VCOSXT;
    wndId2Enum[chkEN_LOADIMP_LDO_AFE] = LMS7002MCSR::EN_LOADIMP_LDO_AFE;
    wndId2Enum[chkEN_LOADIMP_LDO_CPGN] = LMS7002MCSR::EN_LOADIMP_LDO_CPGN;
    wndId2Enum[chkEN_LOADIMP_LDO_CPSXR] = LMS7002MCSR::EN_LOADIMP_LDO_CPSXR;
    wndId2Enum[chkEN_LOADIMP_LDO_CPSXT] = LMS7002MCSR::EN_LOADIMP_LDO_CPSXT;
    wndId2Enum[chkEN_LOADIMP_LDO_DIG] = LMS7002MCSR::EN_LOADIMP_LDO_DIG;
    wndId2Enum[chkEN_LOADIMP_LDO_DIGGN] = LMS7002MCSR::EN_LOADIMP_LDO_DIGGN;
    wndId2Enum[chkEN_LOADIMP_LDO_DIGIp1] = LMS7002MCSR::EN_LOADIMP_LDO_DIGIp1;
    wndId2Enum[chkEN_LOADIMP_LDO_DIGIp2] = LMS7002MCSR::EN_LOADIMP_LDO_DIGIp2;
    wndId2Enum[chkEN_LOADIMP_LDO_DIGSXR] = LMS7002MCSR::EN_LOADIMP_LDO_DIGSXR;
    wndId2Enum[chkEN_LOADIMP_LDO_DIGSXT] = LMS7002MCSR::EN_LOADIMP_LDO_DIGSXT;
    wndId2Enum[chkEN_LOADIMP_LDO_DIVGN] = LMS7002MCSR::EN_LOADIMP_LDO_DIVGN;
    wndId2Enum[chkEN_LOADIMP_LDO_DIVSXR] = LMS7002MCSR::EN_LOADIMP_LDO_DIVSXR;
    wndId2Enum[chkEN_LOADIMP_LDO_DIVSXT] = LMS7002MCSR::EN_LOADIMP_LDO_DIVSXT;
    wndId2Enum[chkEN_LOADIMP_LDO_LNA12] = LMS7002MCSR::EN_LOADIMP_LDO_LNA12;
    wndId2Enum[chkEN_LOADIMP_LDO_LNA14] = LMS7002MCSR::EN_LOADIMP_LDO_LNA14;
    wndId2Enum[chkEN_LOADIMP_LDO_MXRFE] = LMS7002MCSR::EN_LOADIMP_LDO_MXRFE;
    wndId2Enum[chkEN_LOADIMP_LDO_RBB] = LMS7002MCSR::EN_LOADIMP_LDO_RBB;
    wndId2Enum[chkEN_LOADIMP_LDO_RXBUF] = LMS7002MCSR::EN_LOADIMP_LDO_RXBUF;
    wndId2Enum[chkEN_LOADIMP_LDO_SPIBUF] = LMS7002MCSR::EN_LOADIMP_LDO_SPIBUF;
    wndId2Enum[chkEN_LOADIMP_LDO_TBB] = LMS7002MCSR::EN_LOADIMP_LDO_TBB;
    wndId2Enum[chkEN_LOADIMP_LDO_TIA12] = LMS7002MCSR::EN_LOADIMP_LDO_TIA12;
    wndId2Enum[chkEN_LOADIMP_LDO_TIA14] = LMS7002MCSR::EN_LOADIMP_LDO_TIA14;
    wndId2Enum[chkEN_LOADIMP_LDO_TLOB] = LMS7002MCSR::EN_LOADIMP_LDO_TLOB;
    wndId2Enum[chkEN_LOADIMP_LDO_TPAD] = LMS7002MCSR::EN_LOADIMP_LDO_TPAD;
    wndId2Enum[chkEN_LOADIMP_LDO_TXBUF] = LMS7002MCSR::EN_LOADIMP_LDO_TXBUF;
    wndId2Enum[chkEN_LOADIMP_LDO_VCOGN] = LMS7002MCSR::EN_LOADIMP_LDO_VCOGN;
    wndId2Enum[chkEN_LOADIMP_LDO_VCOSXR] = LMS7002MCSR::EN_LOADIMP_LDO_VCOSXR;
    wndId2Enum[chkEN_LOADIMP_LDO_VCOSXT] = LMS7002MCSR::EN_LOADIMP_LDO_VCOSXT;
    wndId2Enum[cmbRDIV_AFE] = LMS7002MCSR::RDIV_AFE;
    wndId2Enum[cmbRDIV_CPGN] = LMS7002MCSR::RDIV_CPGN;
    wndId2Enum[cmbRDIV_CPSXR] = LMS7002MCSR::RDIV_CPSXR;
    wndId2Enum[cmbRDIV_CPSXT] = LMS7002MCSR::RDIV_CPSXT;
    wndId2Enum[cmbRDIV_DIG] = LMS7002MCSR::RDIV_DIG;
    wndId2Enum[cmbRDIV_DIGGN] = LMS7002MCSR::RDIV_DIGGN;
    wndId2Enum[cmbRDIV_DIGIp1] = LMS7002MCSR::RDIV_DIGIp1;
    wndId2Enum[cmbRDIV_DIGIp2] = LMS7002MCSR::RDIV_DIGIp2;
    wndId2Enum[cmbRDIV_DIGSXR] = LMS7002MCSR::RDIV_DIGSXR;
    wndId2Enum[cmbRDIV_DIGSXT] = LMS7002MCSR::RDIV_DIGSXT;
    wndId2Enum[cmbRDIV_DIVGN] = LMS7002MCSR::RDIV_DIVGN;
    wndId2Enum[cmbRDIV_DIVSXR] = LMS7002MCSR::RDIV_DIVSXR;
    wndId2Enum[cmbRDIV_DIVSXT] = LMS7002MCSR::RDIV_DIVSXT;
    wndId2Enum[cmbRDIV_LNA12] = LMS7002MCSR::RDIV_LNA12;
    wndId2Enum[cmbRDIV_LNA14] = LMS7002MCSR::RDIV_LNA14;
    wndId2Enum[cmbRDIV_MXRFE] = LMS7002MCSR::RDIV_MXRFE;
    wndId2Enum[cmbRDIV_RBB] = LMS7002MCSR::RDIV_RBB;
    wndId2Enum[cmbRDIV_RXBUF] = LMS7002MCSR::RDIV_RXBUF;
    wndId2Enum[cmbRDIV_SPIBUF] = LMS7002MCSR::RDIV_SPIBUF;
    wndId2Enum[cmbRDIV_TBB] = LMS7002MCSR::RDIV_TBB;
    wndId2Enum[cmbRDIV_TIA12] = LMS7002MCSR::RDIV_TIA12;
    wndId2Enum[cmbRDIV_TIA14] = LMS7002MCSR::RDIV_TIA14;
    wndId2Enum[cmbRDIV_TLOB] = LMS7002MCSR::RDIV_TLOB;
    wndId2Enum[cmbRDIV_TPAD] = LMS7002MCSR::RDIV_TPAD;
    wndId2Enum[cmbRDIV_TXBUF] = LMS7002MCSR::RDIV_TXBUF;
    wndId2Enum[cmbRDIV_VCOGN] = LMS7002MCSR::RDIV_VCOGN;
    wndId2Enum[cmbRDIV_VCOSXR] = LMS7002MCSR::RDIV_VCOSXR;
    wndId2Enum[cmbRDIV_VCOSXT] = LMS7002MCSR::RDIV_VCOSXT;
    wndId2Enum[chkSPDUP_LDO_AFE] = LMS7002MCSR::SPDUP_LDO_AFE;
    wndId2Enum[chkSPDUP_LDO_CPGN] = LMS7002MCSR::SPDUP_LDO_CPGN;
    wndId2Enum[chkSPDUP_LDO_CPSXR] = LMS7002MCSR::SPDUP_LDO_CPSXR;
    wndId2Enum[chkSPDUP_LDO_CPSXT] = LMS7002MCSR::SPDUP_LDO_CPSXT;
    wndId2Enum[chkSPDUP_LDO_DIG] = LMS7002MCSR::SPDUP_LDO_DIG;
    wndId2Enum[chkSPDUP_LDO_DIGGN] = LMS7002MCSR::SPDUP_LDO_DIGGN;
    wndId2Enum[chkSPDUP_LDO_DIGIp1] = LMS7002MCSR::SPDUP_LDO_DIGIp1;
    wndId2Enum[chkSPDUP_LDO_DIGIp2] = LMS7002MCSR::SPDUP_LDO_DIGIp2;
    wndId2Enum[chkSPDUP_LDO_DIGSXR] = LMS7002MCSR::SPDUP_LDO_DIGSXR;
    wndId2Enum[chkSPDUP_LDO_DIGSXT] = LMS7002MCSR::SPDUP_LDO_DIGSXT;
    wndId2Enum[chkSPDUP_LDO_DIVGN] = LMS7002MCSR::SPDUP_LDO_DIVGN;
    wndId2Enum[chkSPDUP_LDO_DIVSXR] = LMS7002MCSR::SPDUP_LDO_DIVSXR;
    wndId2Enum[chkSPDUP_LDO_DIVSXT] = LMS7002MCSR::SPDUP_LDO_DIVSXT;
    wndId2Enum[chkSPDUP_LDO_LNA12] = LMS7002MCSR::SPDUP_LDO_LNA12;
    wndId2Enum[chkSPDUP_LDO_LNA14] = LMS7002MCSR::SPDUP_LDO_LNA14;
    wndId2Enum[chkSPDUP_LDO_MXRFE] = LMS7002MCSR::SPDUP_LDO_MXRFE;
    wndId2Enum[chkSPDUP_LDO_RBB] = LMS7002MCSR::SPDUP_LDO_RBB;
    wndId2Enum[chkSPDUP_LDO_RXBUF] = LMS7002MCSR::SPDUP_LDO_RXBUF;
    wndId2Enum[chkSPDUP_LDO_SPIBUF] = LMS7002MCSR::SPDUP_LDO_SPIBUF;
    wndId2Enum[chkSPDUP_LDO_TBB] = LMS7002MCSR::SPDUP_LDO_TBB;
    wndId2Enum[chkSPDUP_LDO_TIA12] = LMS7002MCSR::SPDUP_LDO_TIA12;
    wndId2Enum[chkSPDUP_LDO_TIA14] = LMS7002MCSR::SPDUP_LDO_TIA14;
    wndId2Enum[chkSPDUP_LDO_TLOB] = LMS7002MCSR::SPDUP_LDO_TLOB;
    wndId2Enum[chkSPDUP_LDO_TPAD] = LMS7002MCSR::SPDUP_LDO_TPAD;
    wndId2Enum[chkSPDUP_LDO_TXBUF] = LMS7002MCSR::SPDUP_LDO_TXBUF;
    wndId2Enum[chkSPDUP_LDO_VCOGN] = LMS7002MCSR::SPDUP_LDO_VCOGN;
    wndId2Enum[chkSPDUP_LDO_VCOSXR] = LMS7002MCSR::SPDUP_LDO_VCOSXR;
    wndId2Enum[chkSPDUP_LDO_VCOSXT] = LMS7002MCSR::SPDUP_LDO_VCOSXT;
    wndId2Enum[cmbISINK_SPIBUFF] = LMS7002MCSR::ISINK_SPIBUFF;
    wxArrayString temp;
    temp.clear();
    for (int i = 0; i < 256; ++i)
    {
    ...
    cmbRDIV_AFE->Set(temp);
    cmbRDIV_CPGN->Set(temp);
    cmbRDIV_CPSXR->Set(temp);
    cmbRDIV_CPSXT->Set(temp);
    cmbRDIV_DIG->Set(temp);
    cmbRDIV_DIGGN->Set(temp);
    cmbRDIV_DIGIp1->Set(temp);
    cmbRDIV_DIGIp2->Set(temp);
    cmbRDIV_DIGSXR->Set(temp);
    cmbRDIV_DIGSXT->Set(temp);
    cmbRDIV_DIVGN->Set(temp);
    cmbRDIV_DIVSXR->Set(temp);
    cmbRDIV_DIVSXT->Set(temp);
    cmbRDIV_LNA12->Set(temp);
    cmbRDIV_LNA14->Set(temp);
    cmbRDIV_MXRFE->Set(temp);
    cmbRDIV_RBB->Set(temp);
    cmbRDIV_RXBUF->Set(temp);
    cmbRDIV_SPIBUF->Set(temp);
    cmbRDIV_TBB->Set(temp);
    cmbRDIV_TIA12->Set(temp);
    cmbRDIV_TIA14->Set(temp);
    cmbRDIV_TLOB->Set(temp);
    cmbRDIV_TPAD->Set(temp);
    cmbRDIV_TXBUF->Set(temp);
    cmbRDIV_VCOGN->Set(temp);
    cmbRDIV_VCOSXR->Set(temp);
    cmbRDIV_VCOSXT->Set(temp);
