    ...
    : ILMS7002MTab(parent, id, pos, size, style)
{
    ...
    ID_STATICTEXT3 =
        new wxStaticText(sbSizer159->GetStaticBox(), wxID_ANY, wxT("PGA Feedback capacitor"), wxDefaultPosition, wxDefaultSize, 0);
    ID_STATICTEXT3->Wrap(-1);
    rxSizer->Add(ID_STATICTEXT3, 0, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 0);

    cmbC_CTL_PGA_RBB = new NumericSlider(
        sbSizer159->GetStaticBox(), ID_C_CTL_PGA_RBB, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 3, 0);
    ...
    ID_STATICTEXT6 = new wxStaticText(
        sbSizer148->GetStaticBox(), wxID_ANY, wxT("TXPAD linearizing part gain"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    ID_STATICTEXT7 =
        new wxStaticText(sbSizer148->GetStaticBox(), wxID_ANY, wxT("TXPAD gain control"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    ID_STATICTEXT21 =
        new wxStaticText(sbSizer148->GetStaticBox(), wxID_ANY, wxT("Frontend gain"), wxDefaultPosition, wxDefaultSize, 0);
    ID_STATICTEXT21->Wrap(-1);
    txSizer->Add(ID_STATICTEXT21, 0, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 0);

    cmbCG_IAMP_TBB = new NumericSlider(
        sbSizer148->GetStaticBox(), ID_CG_IAMP_TBB, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 63, 0);
    ...
    m_staticText360 =
        new wxStaticText(sbSizer135->GetStaticBox(), wxID_ANY, wxT("IN crest factor"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    wndId2Enum[cmbG_LNA_RFE] = LMS7002MCSR::G_LNA_RFE_R3;
    wndId2Enum[cmbG_TIA_RFE] = LMS7002MCSR::G_TIA_RFE_R3;
    wndId2Enum[cmbCG_IAMP_TBB] = LMS7002MCSR::CG_IAMP_TBB_R3;
    wndId2Enum[cmbLOSS_LIN_TXPAD_TRF] = LMS7002MCSR::LOSS_LIN_TXPAD_R3;
    wndId2Enum[cmbLOSS_MAIN_TXPAD_TRF] = LMS7002MCSR::LOSS_MAIN_TXPAD_R3;
    wndId2Enum[cmbC_CTL_PGA_RBB] = LMS7002MCSR::C_CTL_PGA_RBB_R3;
...
void lms7002_pnlGains_view::Initialize(LMS7002M* pControl)
{
    ...
    if (ReadParam(LMS7002MCSR::MASK) == 0)
    {
...
void lms7002_pnlGains_view::UpdateGUI()
{
    ...
    uint16_t value;
    value = ReadParam(LMS7002MCSR::G_LNA_RFE_R3);
    cmbG_LNA_RFE->SetSelection(value2index(value, g_lna_rfe_IndexValuePairs));

    value = ReadParam(LMS7002MCSR::G_TIA_RFE_R3);
