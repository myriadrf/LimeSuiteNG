...
wxCheckBox* lms7002_pnlRFE_view::NewCheckBox(wxWindow* parent,
    const LMS7002MCSR param,
...
wxComboBox* lms7002_pnlRFE_view::NewComboBox(wxWindow* parent,
    const LMS7002MCSR param,
    const wxString& tooltip = wxEmptyString,
    const wxPoint& pos = wxDefaultPosition,
    const wxSize& size = wxDefaultSize)
    ...
    : ILMS7002MTab(parent, id, pos, size, style)
{
    ...
    { // power downs and input shorts
        ...
        wxStaticBoxSizer* sbSizerPowerDowns;
        {
            ...
            auto rows = { make_tuple(LMS7002MCSR::PD_LNA_RFE, wxT("LNA_RFE"), wxT("Power control signal for LNA_RFE")),
                make_tuple(LMS7002MCSR::PD_RLOOPB_1_RFE, wxT("Loopback 1"), wxT("Power control signal for RXFE loopback 1")),
                make_tuple(LMS7002MCSR::PD_RLOOPB_2_RFE, wxT("Loopback 2"), wxT("Power control signal for RXFE loopback 2")),
                make_tuple(
                    LMS7002MCSR::PD_MXLOBUF_RFE, wxT("Mixer LO buffer"), wxT("Power control signal for RXFE mixer lo buffer")),
                make_tuple(LMS7002MCSR::PD_QGEN_RFE,
                    wxT("Quadrature LO generator"),
                    wxT("Power control signal for RXFE Quadrature LO generator")),
                make_tuple(LMS7002MCSR::PD_RSSI_RFE, wxT("RSSI"), wxT("Power control signal for RXFE RSSI")),
                make_tuple(LMS7002MCSR::PD_TIA_RFE, wxT("TIA"), wxT("Power control signal for RXFE TIA")),
                make_tuple(LMS7002MCSR::EN_G_RFE, wxT("Enable RFE module"), wxT("Enable control for all the RFE_1 power downs")) };

            for (const auto& row : rows)
                sbSizerPowerDowns->Add(
                    NewCheckBox(sbSizerPowerDowns->GetStaticBox(), get<0>(row), get<1>(row), get<2>(row)), wxALIGN_LEFT);
...

    {
        ...
        wxComboBox* cmbSEL_PATH_RFE = NewComboBox(this, LMS7002MCSR::SEL_PATH_RFE);
        ...
        cmbCAP_RXMXO_RFE = NewComboBox(this, LMS7002MCSR::CAP_RXMXO_RFE);
        ...
        cmbRCOMP_TIA_RFE = NewComboBox(this, LMS7002MCSR::RCOMP_TIA_RFE);
        ...
        cmbRFB_TIA_RFE = NewComboBox(this, LMS7002MCSR::RFB_TIA_RFE);
    ...
    wxComboBox* cmbICT_LNACMO_RFE = NewComboBox(sbSizerCurrentControl->GetStaticBox(), LMS7002MCSR::ICT_LNACMO_RFE);
    ...
    wxComboBox* cmbICT_LNA_RFE = NewComboBox(sbSizerCurrentControl->GetStaticBox(), LMS7002MCSR::ICT_LNA_RFE);
    ...
    cmbICT_LODC_RFE = NewComboBox(sbSizerDC->GetStaticBox(), LMS7002MCSR::ICT_LODC_RFE);
    ...
    wxCheckBox* chkEN_DCOFF_RXFE_RFE = new wxCheckBox(
        sbSizerDC->GetStaticBox(), ID_EN_DCOFF_RXFE_RFE, wxT("Enable DC offset"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    fgSizer49->Add(new wxStaticText(sbSizerCapacitorControls->GetStaticBox(), wxID_ANY, wxT("Compensation TIA")),
        0,
        wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL,
        0);

    cmbCCOMP_TIA_RFE = NewComboBox(sbSizerCapacitorControls->GetStaticBox(), LMS7002MCSR::CCOMP_TIA_RFE);
    cmbCCOMP_TIA_RFE->SetToolTip(wxT("Compensation capacitor for TIA"));

    fgSizer49->Add(cmbCCOMP_TIA_RFE, 1, wxEXPAND, 0);

    fgSizer49->Add(new wxStaticText(sbSizerCapacitorControls->GetStaticBox(), wxID_ANY, wxT("Feedback TIA")),
        0,
        wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL,
        0);

    cmbCFB_TIA_RFE = NewNumericSlider(sbSizerCapacitorControls->GetStaticBox(),
        LMS7002MCSR::CFB_TIA_RFE,
    ...
    cmbG_LNA_RFE = NewComboBox(sbSizerGainControls->GetStaticBox(), LMS7002MCSR::G_LNA_RFE);
    cmbG_LNA_RFE->SetToolTip(wxT("Controls the gain of the LNA"));
    SizerAddTextAndControl(fgSizer50, wxT("LNA"), cmbG_LNA_RFE);

    cmbG_RXLOOPB_RFE = NewComboBox(sbSizerGainControls->GetStaticBox(), LMS7002MCSR::G_RXLOOPB_RFE);
    ...
    cmbG_TIA_RFE = NewComboBox(sbSizerGainControls->GetStaticBox(), LMS7002MCSR::G_TIA_RFE);
    ...
    cmbICT_LOOPB_RFE = NewComboBox(sbSizerRefCurrent->GetStaticBox(), LMS7002MCSR::ICT_LOOPB_RFE);
    ...
    fgSizer51->Add(new wxStaticText(sbSizerTrimDuty->GetStaticBox(), wxID_ANY, wxT("I channel:")),
        0,
        wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL,
        5);

    cmbCDC_I_RFE = NewComboBox(sbSizerTrimDuty->GetStaticBox(), LMS7002MCSR::CDC_I_RFE);
    ...
    cmbCDC_Q_RFE = NewComboBox(sbSizerTrimDuty->GetStaticBox(), LMS7002MCSR::CDC_Q_RFE);
...
void lms7002_pnlRFE_view::ParameterChangeHandler(wxCommandEvent& event)
{
    ...
    else if (event.GetEventObject() == cmbDCOFFI_RFE || event.GetEventObject() == cmbDCOFFQ_RFE)
    {
        ...
        WriteParam(parameter, valToSend);
        return;
    }
