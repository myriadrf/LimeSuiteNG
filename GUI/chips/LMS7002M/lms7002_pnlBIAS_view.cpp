    ...
    : ILMS7002MTab(parent, id, pos, size, style)
{
    ...
    chkPD_FRP_BIAS =
        new wxCheckBox(sbSizerPowerDowns->GetStaticBox(), ID_PD_FRP_BIAS, wxT("Fix/RP block"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkPD_PTRP_BIAS = new wxCheckBox(
        sbSizerPowerDowns->GetStaticBox(), ID_PD_PTRP_BIAS, wxT("PTAT/RP block"), wxDefaultPosition, wxDefaultSize, 0);
    chkPD_PTRP_BIAS->SetToolTip(wxT("Power down signal for PTAT/RP block"));

    fgSizer66->Add(chkPD_PTRP_BIAS, 0, flags, 0);

    chkPD_PT_BIAS =
        new wxCheckBox(sbSizerPowerDowns->GetStaticBox(), ID_PD_PT_BIAS, wxT("PTAT block"), wxDefaultPosition, wxDefaultSize, 0);
    chkPD_PT_BIAS->SetToolTip(wxT("Power down signal for PTAT block"));

    fgSizer66->Add(chkPD_PT_BIAS, 0, flags, 0);

    chkPD_BIAS_MASTER = new wxCheckBox(
        sbSizerPowerDowns->GetStaticBox(), ID_PD_BIAS_MASTER, wxT("Power down all block"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    wndId2Enum[chkPD_FRP_BIAS] = LMS7002MCSR::PD_FRP_BIAS;
    wndId2Enum[chkPD_F_BIAS] = LMS7002MCSR::PD_F_BIAS;
    wndId2Enum[chkPD_PTRP_BIAS] = LMS7002MCSR::PD_PTRP_BIAS;
    wndId2Enum[chkPD_PT_BIAS] = LMS7002MCSR::PD_PT_BIAS;
    wndId2Enum[cmbRP_CALIB_BIAS] = LMS7002MCSR::RP_CALIB_BIAS;
