    ...
    : ILMS7002MTab(parent, id, pos, size, style)
{
    ...
    wndId2Enum[rgrMODE_INTERLEAVE_AFE] = LMS7002MCSR::MODE_INTERLEAVE_AFE;
    wndId2Enum[cmbMUX_AFE_1] = LMS7002MCSR::MUX_AFE_1;
    wndId2Enum[cmbMUX_AFE_2] = LMS7002MCSR::MUX_AFE_2;
    wndId2Enum[chkPD_AFE] = LMS7002MCSR::PD_AFE;
    wndId2Enum[chkPD_RX_AFE1] = LMS7002MCSR::PD_RX_AFE1;
    wndId2Enum[chkPD_RX_AFE2] = LMS7002MCSR::PD_RX_AFE2;
    wndId2Enum[chkPD_TX_AFE1] = LMS7002MCSR::PD_TX_AFE1;
    wndId2Enum[chkPD_TX_AFE2] = LMS7002MCSR::PD_TX_AFE2;
