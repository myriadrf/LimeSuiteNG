    ...
    : ILMS7002MTab(parent, id, pos, size, style)
{
    ...
    chkPD_LPFH_TBB = new wxCheckBox(
        sbSizerPowerDowns->GetStaticBox(), ID_PD_LPFH_TBB, wxT("LPFH_TBB biquad"), wxDefaultPosition, wxDefaultSize, 0);
    chkPD_LPFH_TBB->SetToolTip(wxT("This selectively powers down the LPFH_TBB biquad"));

    fgSizer59->Add(chkPD_LPFH_TBB, 0, flags, 0);

    chkPD_LPFIAMP_TBB = new wxCheckBox(sbSizerPowerDowns->GetStaticBox(),
        ID_PD_LPFIAMP_TBB,
        wxT("LPFIAMP_TBB front-end current amp"),
        wxDefaultPosition,
        wxDefaultSize,
        0);
    ...
    chkPD_LPFLAD_TBB = new wxCheckBox(sbSizerPowerDowns->GetStaticBox(),
        ID_PD_LPFLAD_TBB,
        wxT("LPFLAD_TBB low pass ladder filter"),
        wxDefaultPosition,
        wxDefaultSize,
        0);
    chkPD_LPFLAD_TBB->SetToolTip(
        wxT("This selectively powers down the LPFLAD_TBB low pass ladder filter of the transmitter baseband"));

    fgSizer59->Add(chkPD_LPFLAD_TBB, 0, flags, 0);

    chkPD_LPFS5_TBB = new wxCheckBox(sbSizerPowerDowns->GetStaticBox(),
        ID_PD_LPFS5_TBB,
        wxT("LPFS5_TBB low pass real-pole filter"),
        wxDefaultPosition,
        wxDefaultSize,
        0);
    chkPD_LPFS5_TBB->SetToolTip(
        wxT("This selectively powers down the LPFS5_TBB low pass real-pole filter of the transmitter baseband"));

    fgSizer59->Add(chkPD_LPFS5_TBB, 0, flags, 0);

    chkEN_G_TBB = new wxCheckBox(
        sbSizerPowerDowns->GetStaticBox(), ID_EN_G_TBB, wxT("Enable TBB module"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkEN_DIR_TBB = new wxCheckBox(
        sbSizer39->GetStaticBox(), ID_EN_DIR_TBB, wxT("Direct control of PDs and ENs"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    chkBYPLADDER_TBB->SetToolTip(wxT("This signal bypasses the LPF ladder of TBB and directly connects the output of current "
    ...
    chkR5_LPF_BYP_TBB =
        new wxCheckBox(this, ID_BYPLADDER_TBB, wxT("Bypass LPFS5 filter capacitor banks"), wxDefaultPosition, wxDefaultSize, 0);
    chkR5_LPF_BYP_TBB->SetToolTip(wxT("This signal bypasses the LPF ladder of TBB and directly connects the output of current "
                                      "amplifier to the null port of the real pole stage of TBB low pass filter"));
    ...
    cmbTSTIN_TBB = new wxComboBox(this, ID_TSTIN_TBB, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, nullptr, 0);
    cmbTSTIN_TBB->SetToolTip(
        wxT("This control selects where the input test signal (vinp/n_aux_bbq/i) is routed to as well as disabling the route."));
    ...
    cmbCG_IAMP_TBB =
        new NumericSlider(this, ID_CG_IAMP_TBB, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 63, 0);
    ...
    ID_STATICTEXT3 = new wxStaticText(
        sbSizer141->GetStaticBox(), wxID_ANY, wxT("IAMP main bias current sources"), wxDefaultPosition, wxDefaultSize, 0);
    ID_STATICTEXT3->Wrap(-1);
    fgSizer260->Add(ID_STATICTEXT3, 0, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 0);

    cmbICT_IAMP_FRP_TBB = new NumericSlider(sbSizer141->GetStaticBox(),
        ID_ICT_IAMP_FRP_TBB,
        wxEmptyString,
        wxDefaultPosition,
        wxDefaultSize,
    ...
    ID_STATICTEXT4 = new wxStaticText(
        sbSizer141->GetStaticBox(), wxID_ANY, wxT("IAMP cascade transistors gate voltage"), wxDefaultPosition, wxDefaultSize, 0);
    ID_STATICTEXT4->Wrap(-1);
    fgSizer260->Add(ID_STATICTEXT4, 0, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 0);

    cmbICT_IAMP_GG_FRP_TBB = new NumericSlider(sbSizer141->GetStaticBox(),
    ...
    ID_STATICTEXT6 = new wxStaticText(sbSizerOpamp->GetStaticBox(),
        wxID_ANY,
        wxT("Output stage bias current low band real pole filter"),
        wxDefaultPosition,
        wxDefaultSize,
        0);
    ...
    cmbICT_LPFS5_F_TBB = new wxComboBox(
        sbSizerOpamp->GetStaticBox(), ID_ICT_LPFS5_F_TBB, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, nullptr, 0);
    cmbICT_LPFS5_F_TBB->SetToolTip(wxT("This controls the operational amplifier's output stage bias current of the low band real "
                                       "pole filter of the transmitter's baseband"));

    fgSizer60->Add(cmbICT_LPFS5_F_TBB, 0, wxEXPAND, 0);

    ID_STATICTEXT7 = new wxStaticText(sbSizerOpamp->GetStaticBox(),
        wxID_ANY,
        wxT("Input stage bias current of low band real pole filter"),
        wxDefaultPosition,
        wxDefaultSize,
        0);
    ...
    cmbICT_LPFS5_PT_TBB = new wxComboBox(
        sbSizerOpamp->GetStaticBox(), ID_ICT_LPFS5_PT_TBB, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, nullptr, 0);
    cmbICT_LPFS5_PT_TBB->SetToolTip(wxT("This controls the operational amplifier's input stage bias current of the low band real "
                                        "pole filter of the transmitter's baseband"));

    fgSizer60->Add(cmbICT_LPFS5_PT_TBB, 0, wxEXPAND, 0);

    ID_STATICTEXT8 = new wxStaticText(sbSizerOpamp->GetStaticBox(),
        wxID_ANY,
        wxT("Input stage bias reference current of high band low pass filter"),
        wxDefaultPosition,
        wxDefaultSize,
        0);
    ...
    cmbICT_LPF_H_PT_TBB = new wxComboBox(
        sbSizerOpamp->GetStaticBox(), ID_ICT_LPF_H_PT_TBB, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, nullptr, 0);
    cmbICT_LPF_H_PT_TBB->SetToolTip(wxT("This controls the operational amplifiers input stage bias reference current of the high "
                                        "band low pass filter of the transmitter's baseband "));

    fgSizer60->Add(cmbICT_LPF_H_PT_TBB, 0, wxEXPAND, 0);

    ID_STATICTEXT9 = new wxStaticText(sbSizerOpamp->GetStaticBox(),
        wxID_ANY,
        wxT("Output stage bias reference current of high band low pass filter"),
        wxDefaultPosition,
        wxDefaultSize,
        0);
    ...
    cmbICT_LPFH_F_TBB = new wxComboBox(
        sbSizerOpamp->GetStaticBox(), ID_ICT_LPFH_F_TBB, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, nullptr, 0);
    cmbICT_LPFH_F_TBB->SetToolTip(wxT("controls the operational amplifiers output stage bias reference current of the high band "
                                      "low pass filter of the transmitter's baseband (LPFH_TBB)"));

    fgSizer60->Add(cmbICT_LPFH_F_TBB, 0, wxEXPAND, 0);

    ID_STATICTEXT10 = new wxStaticText(sbSizerOpamp->GetStaticBox(),
        wxID_ANY,
        wxT("Output stage bias reference of low band ladder filter"),
        wxDefaultPosition,
        wxDefaultSize,
        0);
    ...
    ID_STATICTEXT11 = new wxStaticText(sbSizerOpamp->GetStaticBox(),
        wxID_ANY,
        wxT("Input stage bias reference of low band ladder filter"),
        wxDefaultPosition,
        wxDefaultSize,
        0);
    ...
    ID_STATICTEXT12 = new wxStaticText(sbSizerResistorBanks->GetStaticBox(),
        wxID_ANY,
        wxT("LPFH equivalent resistance stage"),
        wxDefaultPosition,
        wxDefaultSize,
        0);
    ...
    cmbRCAL_LPFH_TBB = new NumericSlider(sbSizerResistorBanks->GetStaticBox(),
        ID_RCAL_LPFH_TBB,
        wxEmptyString,
        wxDefaultPosition,
        wxDefaultSize,
    ...
    ID_STATICTEXT13 = new wxStaticText(sbSizerResistorBanks->GetStaticBox(),
        wxID_ANY,
        wxT("LPFLAD equivalent resistance stage"),
        wxDefaultPosition,
        wxDefaultSize,
        0);
    ...
    cmbRCAL_LPFLAD_TBB = new NumericSlider(sbSizerResistorBanks->GetStaticBox(),
        ID_RCAL_LPFLAD_TBB,
        wxEmptyString,
        wxDefaultPosition,
        wxDefaultSize,
    ...
    ID_STATICTEXT15 = new wxStaticText(sbSizerResistorBanks->GetStaticBox(),
        wxID_ANY,
        wxT("LPFS5 equivalent resistance stage"),
        wxDefaultPosition,
        wxDefaultSize,
        0);
    ...
    cmbRCAL_LPFS5_TBB = new NumericSlider(sbSizerResistorBanks->GetStaticBox(),
        ID_RCAL_LPFS5_TBB,
        wxEmptyString,
        wxDefaultPosition,
        wxDefaultSize,
    ...
    ID_STATICTEXT14 = new wxStaticText(sbSizerResistorBanks->GetStaticBox(),
        wxID_ANY,
        wxT("Common control signal for all TBB filters"),
        wxDefaultPosition,
        wxDefaultSize,
        0);
    ...
    cmbCCAL_LPFLAD_TBB = new NumericSlider(sbSizerResistorBanks->GetStaticBox(),
        ID_CCAL_LPFLAD_TBB,
        wxEmptyString,
        wxDefaultPosition,
        wxDefaultSize,
    ...
    lblFilterInputName = new wxStaticText(
        sbSizerRxFilters->GetStaticBox(), wxID_ANY, wxT("RF bandwidth (MHz)"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    btnTuneFilter =
        new wxButton(sbSizerRxFilters->GetStaticBox(), ID_BTN_TUNE_FILTER, wxT("TUNE"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    // Connect Events
    chkPD_LPFH_TBB->Connect(
        wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler(lms7002_pnlTBB_view::ParameterChangeHandler), nullptr, this);
    chkPD_LPFIAMP_TBB->Connect(
        wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler(lms7002_pnlTBB_view::ParameterChangeHandler), nullptr, this);
    chkPD_LPFLAD_TBB->Connect(
        wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler(lms7002_pnlTBB_view::ParameterChangeHandler), nullptr, this);
    chkPD_LPFS5_TBB->Connect(
        wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler(lms7002_pnlTBB_view::ParameterChangeHandler), nullptr, this);
    chkEN_G_TBB->Connect(
        wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler(lms7002_pnlTBB_view::ParameterChangeHandler), nullptr, this);
    chkEN_DIR_TBB->Connect(
        wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler(lms7002_pnlTBB_view::ParameterChangeHandler), nullptr, this);
    chkBYPLADDER_TBB->Connect(
        wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler(lms7002_pnlTBB_view::ParameterChangeHandler), nullptr, this);
    chkR5_LPF_BYP_TBB->Connect(
        wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler(lms7002_pnlTBB_view::ParameterChangeHandler), nullptr, this);
    cmbLOOPB_TBB->Connect(
        wxEVT_COMMAND_COMBOBOX_SELECTED, wxCommandEventHandler(lms7002_pnlTBB_view::ParameterChangeHandler), nullptr, this);
    cmbTSTIN_TBB->Connect(
        wxEVT_COMMAND_COMBOBOX_SELECTED, wxCommandEventHandler(lms7002_pnlTBB_view::ParameterChangeHandler), nullptr, this);
    cmbCG_IAMP_TBB->Connect(
        wxEVT_COMMAND_SPINCTRL_UPDATED, wxSpinEventHandler(lms7002_pnlTBB_view::ParameterChangeHandler), nullptr, this);
    cmbICT_IAMP_FRP_TBB->Connect(
        wxEVT_COMMAND_SPINCTRL_UPDATED, wxSpinEventHandler(lms7002_pnlTBB_view::ParameterChangeHandler), nullptr, this);
    cmbICT_IAMP_GG_FRP_TBB->Connect(
        wxEVT_COMMAND_SPINCTRL_UPDATED, wxSpinEventHandler(lms7002_pnlTBB_view::ParameterChangeHandler), nullptr, this);
    cmbICT_LPFS5_F_TBB->Connect(
        wxEVT_COMMAND_COMBOBOX_SELECTED, wxCommandEventHandler(lms7002_pnlTBB_view::ParameterChangeHandler), nullptr, this);
    cmbICT_LPFS5_PT_TBB->Connect(
        wxEVT_COMMAND_COMBOBOX_SELECTED, wxCommandEventHandler(lms7002_pnlTBB_view::ParameterChangeHandler), nullptr, this);
    cmbICT_LPF_H_PT_TBB->Connect(
        wxEVT_COMMAND_COMBOBOX_SELECTED, wxCommandEventHandler(lms7002_pnlTBB_view::ParameterChangeHandler), nullptr, this);
    cmbICT_LPFH_F_TBB->Connect(
        wxEVT_COMMAND_COMBOBOX_SELECTED, wxCommandEventHandler(lms7002_pnlTBB_view::ParameterChangeHandler), nullptr, this);
    cmbICT_LPFLAD_F_TBB->Connect(
        wxEVT_COMMAND_COMBOBOX_SELECTED, wxCommandEventHandler(lms7002_pnlTBB_view::ParameterChangeHandler), nullptr, this);
    cmbICT_LPFLAD_PT_TBB->Connect(
        wxEVT_COMMAND_COMBOBOX_SELECTED, wxCommandEventHandler(lms7002_pnlTBB_view::ParameterChangeHandler), nullptr, this);
    cmbRCAL_LPFH_TBB->Connect(
        wxEVT_COMMAND_SPINCTRL_UPDATED, wxSpinEventHandler(lms7002_pnlTBB_view::ParameterChangeHandler), nullptr, this);
    cmbRCAL_LPFLAD_TBB->Connect(
        wxEVT_COMMAND_SPINCTRL_UPDATED, wxSpinEventHandler(lms7002_pnlTBB_view::ParameterChangeHandler), nullptr, this);
    cmbRCAL_LPFS5_TBB->Connect(
        wxEVT_COMMAND_SPINCTRL_UPDATED, wxSpinEventHandler(lms7002_pnlTBB_view::ParameterChangeHandler), nullptr, this);
    cmbCCAL_LPFLAD_TBB->Connect(
        wxEVT_COMMAND_SPINCTRL_UPDATED, wxSpinEventHandler(lms7002_pnlTBB_view::ParameterChangeHandler), nullptr, this);
    btnTuneFilter->Connect(
        wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(lms7002_pnlTBB_view::OnbtnTuneFilter), nullptr, this);
    btnTuneTxGain->Connect(
        wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(lms7002_pnlTBB_view::OnbtnTuneTxGain), nullptr, this);

    wndId2Enum[chkBYPLADDER_TBB] = LMS7002MCSR::BYPLADDER_TBB;
    wndId2Enum[cmbCCAL_LPFLAD_TBB] = LMS7002MCSR::CCAL_LPFLAD_TBB;
    wndId2Enum[cmbCG_IAMP_TBB] = LMS7002MCSR::CG_IAMP_TBB;
    wndId2Enum[chkEN_G_TBB] = LMS7002MCSR::EN_G_TBB;
    wndId2Enum[cmbICT_IAMP_FRP_TBB] = LMS7002MCSR::ICT_IAMP_FRP_TBB;
    wndId2Enum[cmbICT_IAMP_GG_FRP_TBB] = LMS7002MCSR::ICT_IAMP_GG_FRP_TBB;
    wndId2Enum[cmbICT_LPFH_F_TBB] = LMS7002MCSR::ICT_LPFH_F_TBB;
    wndId2Enum[cmbICT_LPFLAD_F_TBB] = LMS7002MCSR::ICT_LPFLAD_F_TBB;
    wndId2Enum[cmbICT_LPFLAD_PT_TBB] = LMS7002MCSR::ICT_LPFLAD_PT_TBB;
    wndId2Enum[cmbICT_LPFS5_F_TBB] = LMS7002MCSR::ICT_LPFS5_F_TBB;
    wndId2Enum[cmbICT_LPFS5_PT_TBB] = LMS7002MCSR::ICT_LPFS5_PT_TBB;
    wndId2Enum[cmbICT_LPF_H_PT_TBB] = LMS7002MCSR::ICT_LPF_H_PT_TBB;
    wndId2Enum[cmbLOOPB_TBB] = LMS7002MCSR::LOOPB_TBB;
    wndId2Enum[chkPD_LPFH_TBB] = LMS7002MCSR::PD_LPFH_TBB;
    wndId2Enum[chkPD_LPFIAMP_TBB] = LMS7002MCSR::PD_LPFIAMP_TBB;
    wndId2Enum[chkPD_LPFLAD_TBB] = LMS7002MCSR::PD_LPFLAD_TBB;
    wndId2Enum[chkPD_LPFS5_TBB] = LMS7002MCSR::PD_LPFS5_TBB;
    wndId2Enum[cmbRCAL_LPFH_TBB] = LMS7002MCSR::RCAL_LPFH_TBB;
    wndId2Enum[cmbRCAL_LPFLAD_TBB] = LMS7002MCSR::RCAL_LPFLAD_TBB;
    wndId2Enum[cmbRCAL_LPFS5_TBB] = LMS7002MCSR::RCAL_LPFS5_TBB;
    wndId2Enum[cmbTSTIN_TBB] = LMS7002MCSR::TSTIN_TBB;
    wndId2Enum[chkEN_DIR_TBB] = LMS7002MCSR::EN_DIR_TBB;
    wndId2Enum[chkR5_LPF_BYP_TBB] = LMS7002MCSR::R5_LPF_BYP_TBB;
