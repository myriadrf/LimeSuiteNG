...
TEST(LMS64CProtocol, GPIODirWriteTestOneBlock)
{
    ...
    EXPECT_CALL(mockPort,
        Write(AllOf(IsCommandCorrect(LMS64CProtocol::Command::GPIO_DIR_WR), IsBlockCountCorrect(1), IsPayloadByteCorrect(0, value)),
            PACKET_SIZE,
            _))
        .Times(1);
...
TEST(LMS64CProtocol, GPIODirWriteTestTwoBlocks)
{
    ...
    EXPECT_CALL(mockPort,
        Write(AllOf(IsCommandCorrect(LMS64CProtocol::Command::GPIO_DIR_WR),
...
TEST(LMS64CProtocol, GPIODirWriteTestNotFullyWritten)
{
    ...
    EXPECT_CALL(
        mockPort, Write(AllOf(IsCommandCorrect(LMS64CProtocol::Command::GPIO_DIR_WR), IsBlockCountCorrect(1)), PACKET_SIZE, _))
        .Times(1);
