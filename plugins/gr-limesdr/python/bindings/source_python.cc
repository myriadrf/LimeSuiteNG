...
/* BINDTOOL_HEADER_FILE_HASH(513c2396631d13233148b0f4738adf16)                     */
/***********************************************************************************/
...
void bind_source(py::module& m)
{
    ...
    py::class_<source,
        ...
        .def("write_gpio", &source::write_gpio, py::arg("out"), D(source, write_gpio))


        .def("read_gpio", &source::read_gpio, D(source, read_gpio))
