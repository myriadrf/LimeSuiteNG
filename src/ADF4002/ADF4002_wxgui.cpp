    ...
    , m_pModule(nullptr)
{
    ...
    StaticText1 = new wxStaticText(
        this, ID_STATICTEXT1, _("Lock Detect Precision:"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT1"));
    FlexGridSizer5->Add(StaticText1, 1, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
    StaticText2 =
        new wxStaticText(this, ID_STATICTEXT2, _("Anti-Backlash:"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT2"));
    ...
    spinRCnt =
        new wxSpinCtrl(this, ID_SPINCTRL1, _T("125"), wxDefaultPosition, wxDefaultSize, 0, 0, 16383, 125, _T("ID_SPINCTRL1"));
    ...
    StaticText6 =
        new wxStaticText(this, ID_STATICTEXT6, _("Current Setting 1:"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT6"));
    ...
    StaticText8 =
        new wxStaticText(this, ID_STATICTEXT8, _("Current Setting 2:"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT8"));
    ...
    wxString __wxRadioBoxChoices_1[2] = { _("Negative"), _("Positive") };
    rgrPDP_f = new wxRadioBox(this,
        ID_RADIOBOX1,
        _("PD Polarity"),
        wxDefaultPosition,
        wxDefaultSize,
    ...
    wxString __wxRadioBoxChoices_2[2] = { _("0"), _("1") };
    rgrPD1_f = new wxRadioBox(this,
        ID_RADIOBOX2,
        _("PD1"),
        wxDefaultPosition,
        wxDefaultSize,
        2,
        __wxRadioBoxChoices_2,
        1,
        wxRA_SPECIFY_COLS,
        wxDefaultValidator,
        _T("ID_RADIOBOX2"));
    ...
    wxString __wxRadioBoxChoices_3[2] = { _("Normal"), _("R & N Reset") };
    rgrCR_f = new wxRadioBox(this,
        ID_RADIOBOX3,
        _("Counter Reset"),
        wxDefaultPosition,
        wxDefaultSize,
        2,
        __wxRadioBoxChoices_3,
        1,
        wxRA_SPECIFY_COLS,
        wxDefaultValidator,
        _T("ID_RADIOBOX3"));
    ...
    wxString __wxRadioBoxChoices_4[2] = { _("0"), _("1") };
    rgrPD2_f = new wxRadioBox(this,
        ID_RADIOBOX4,
        _("PD2"),
        wxDefaultPosition,
        wxDefaultSize,
        2,
        __wxRadioBoxChoices_4,
        1,
        wxRA_SPECIFY_COLS,
        wxDefaultValidator,
        _T("ID_RADIOBOX4"));
    ...
    wxString __wxRadioBoxChoices_5[2] = { _("Normal"), _("Three-State") };
    rgrCPS_f = new wxRadioBox(this,
        ID_RADIOBOX5,
        _("CP State"),
        wxDefaultPosition,
        wxDefaultSize,
        2,
        __wxRadioBoxChoices_5,
        1,
        wxRA_SPECIFY_COLS,
        wxDefaultValidator,
        _T("ID_RADIOBOX5"));
    ...
    StaticText14 = new wxStaticText(
        this, ID_STATICTEXT17, _("Current Setting 1:"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT17"));
    ...
    StaticText17 = new wxStaticText(
        this, ID_STATICTEXT19, _("Current Setting 2:"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT19"));
    ...
    wxString __wxRadioBoxChoices_6[2] = { _("Negative"), _("Positive") };
    rgrPDP_i = new wxRadioBox(this,
        ID_RADIOBOX6,
        _("PD Polarity"),
        wxDefaultPosition,
        wxDefaultSize,
        2,
        __wxRadioBoxChoices_6,
        1,
        wxRA_SPECIFY_COLS,
        wxDefaultValidator,
        _T("ID_RADIOBOX6"));
    ...
    wxString __wxRadioBoxChoices_7[2] = { _("0"), _("1") };
    rgrPD1_i = new wxRadioBox(this,
        ID_RADIOBOX7,
        _("PD1"),
        wxDefaultPosition,
        wxDefaultSize,
        2,
        __wxRadioBoxChoices_7,
        1,
        wxRA_SPECIFY_COLS,
        wxDefaultValidator,
        _T("ID_RADIOBOX7"));
    ...
    wxString __wxRadioBoxChoices_8[2] = { _("Normal"), _("R & N Reset") };
    rgrCR_i = new wxRadioBox(this,
        ID_RADIOBOX8,
        _("Counter Reset"),
        wxDefaultPosition,
        wxDefaultSize,
        2,
        __wxRadioBoxChoices_8,
        1,
        wxRA_SPECIFY_COLS,
        wxDefaultValidator,
        _T("ID_RADIOBOX8"));
    ...
    wxString __wxRadioBoxChoices_9[2] = { _("0"), _("1") };
    rgrPD2_i = new wxRadioBox(this,
        ID_RADIOBOX9,
        _("PD2"),
        wxDefaultPosition,
        wxDefaultSize,
        2,
        __wxRadioBoxChoices_9,
        1,
        wxRA_SPECIFY_COLS,
        wxDefaultValidator,
        _T("ID_RADIOBOX9"));
    ...
    wxString __wxRadioBoxChoices_10[2] = { _("Normal"), _("Three-State") };
    rgrCPS_i = new wxRadioBox(this,
        ID_RADIOBOX10,
        _("CP State"),
        wxDefaultPosition,
        wxDefaultSize,
        2,
        __wxRadioBoxChoices_10,
        1,
        wxRA_SPECIFY_COLS,
        wxDefaultValidator,
        _T("ID_RADIOBOX10"));
    ...
    StaticText11 =
        new wxStaticText(this, ID_STATICTEXT11, _("Fref, MHz"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT11"));
    FlexGridSizer11->Add(StaticText11, 1, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
    StaticText12 =
        new wxStaticText(this, ID_STATICTEXT12, _("Fvco, MHz:"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT12"));
    FlexGridSizer11->Add(StaticText12, 1, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
    txtFref =
        new wxTextCtrl(this, ID_TEXTCTRL1, _("10"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL1"));
    FlexGridSizer11->Add(txtFref, 1, wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
    txtFvco =
        new wxTextCtrl(this, ID_TEXTCTRL2, _("30.72"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL2"));
    FlexGridSizer11->Add(txtFvco, 1, wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
    StaticText13 =
        new wxStaticText(this, ID_STATICTEXT13, _("Fvco (MHz) ="), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT13"));
    ...
    btnCalcSend = new wxButton(
        this, ID_BUTTON1, _("Calculate R, N && Upload"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON1"));
    FlexGridSizer12->Add(btnCalcSend, 1, wxEXPAND, 5);
    btnUpload =
        new wxButton(this, ID_BUTTON2, _("Upload"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON2"));
