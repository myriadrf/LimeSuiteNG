...
OpStatus LimeSDR_XTRX::RFTest(OEMTestReporter& reporter, TestData& results)
{
    ...
    statuses.push_back(RunTestConfig(reporter, results.lnal, "TX_2->LNA_L", 1000e6, 0, 2, -12, -14));
    statuses.push_back(RunTestConfig(reporter, results.lnaw, "TX_2->LNA_W", 2000e6, 14, 3, -9, -8));
    statuses.push_back(RunTestConfig(reporter, results.lnah, "TX_1->LNA_H", 3500e6, 35, 1, -2, -8));
