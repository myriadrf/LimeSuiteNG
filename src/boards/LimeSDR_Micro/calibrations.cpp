...
static const bool showPlots = false;
...
static float WriteIQPhase(int32_t value, void* context)
{
    CalibrationContext* ctx = static_cast<CalibrationContext*>(context);
...
static void lms7002m_calibrate_iq_imbalance(CalibrationContext* ctx, bool isTx)
{
    ...
    phaseSearch.set_and_measure = WriteIQPhase;
    ...
    gainSearch.result = 0;
    gainSearch.set_and_measure = WriteIQGain;
