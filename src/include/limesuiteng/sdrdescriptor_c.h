 ...
 */
LIME_API const char* lime_descriptor_name(const lime_SDRDescriptor* d);
 ...
 */
LIME_API uint64_t lime_descriptor_serial(const lime_SDRDescriptor* d);
 ...
 */
LIME_API size_t lime_descriptor_rfsoc_count(const lime_SDRDescriptor* d);
 ...
 */
LIME_API const char* lime_descriptor_rfsoc_name(const lime_SDRDescriptor* d, size_t soc);
 ...
 */
LIME_API uint32_t lime_descriptor_channel_count(const lime_SDRDescriptor* d, size_t soc);
 ...
 */
LIME_API size_t lime_descriptor_antenna_count(const lime_SDRDescriptor* d, size_t soc, lime_TRXDir dir);
 ...
 */
LIME_API const char* lime_descriptor_antenna_name(const lime_SDRDescriptor* d, size_t soc, lime_TRXDir dir, size_t index);
