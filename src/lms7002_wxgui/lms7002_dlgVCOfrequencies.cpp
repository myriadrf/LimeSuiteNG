    ...
    : wxDialog(parent, wxID_ANY, wxT("VCO frequencies"))
{
    ...
    m_staticText342 =
        new wxStaticText(sbSizer129->GetStaticBox(), wxID_ANY, wxT("High(GHz):"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_staticText3411 =
        new wxStaticText(sbSizer1291->GetStaticBox(), wxID_ANY, wxT("Low(GHz):"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_staticText3421 =
        new wxStaticText(sbSizer1291->GetStaticBox(), wxID_ANY, wxT("High(GHz):"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_staticText3412 =
        new wxStaticText(sbSizer1292->GetStaticBox(), wxID_ANY, wxT("Low(GHz):"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_staticText3422 =
        new wxStaticText(sbSizer1292->GetStaticBox(), wxID_ANY, wxT("High(GHz):"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_staticText3413 =
        new wxStaticText(sbSizer1293->GetStaticBox(), wxID_ANY, wxT("Low(GHz):"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_staticText3423 =
        new wxStaticText(sbSizer1293->GetStaticBox(), wxID_ANY, wxT("High(GHz):"), wxDefaultPosition, wxDefaultSize, 0);
