    ...
    : ILMS7002MTab(parent, id, pos, size, style)
{
    ...
    wndId2Enum[rgrDIQ1_DS] = LMS7_DIQ1_DS;
    wndId2Enum[chkDIQ1_PE] = LMS7_DIQ1_PE;
    wndId2Enum[rgrDIQ2_DS] = LMS7_DIQ2_DS;
    wndId2Enum[chkDIQ2_PE] = LMS7_DIQ2_PE;
    wndId2Enum[rgrRX_MUX] = LMS7_RX_MUX;
    wndId2Enum[chkFCLK1_PE] = LMS7_FCLK1_PE;
    wndId2Enum[chkFCLK2_PE] = LMS7_FCLK2_PE;
    wndId2Enum[chkIQ_SEL_EN_1_PE] = LMS7_IQ_SEL_EN_1_PE;
    wndId2Enum[chkIQ_SEL_EN_2_PE] = LMS7_IQ_SEL_EN_2_PE;
    wndId2Enum[cmbLML1_AIP] = LMS7_LML1_AIP;
    wndId2Enum[cmbLML1_AQP] = LMS7_LML1_AQP;
    wndId2Enum[cmbLML1_BIP] = LMS7_LML1_BIP;
    wndId2Enum[cmbLML1_BQP] = LMS7_LML1_BQP;
    wndId2Enum[cmbLML1_RX_PRE] = LMS7_LML1_RF2BB_PRE;
    wndId2Enum[cmbLML1_RX_PST] = LMS7_LML1_RF2BB_PST;
    wndId2Enum[cmbLML1_S0S] = LMS7_LML1_S0S;
    wndId2Enum[cmbLML1_S1S] = LMS7_LML1_S1S;
    wndId2Enum[cmbLML1_S2S] = LMS7_LML1_S2S;
    wndId2Enum[cmbLML1_S3S] = LMS7_LML1_S3S;
    wndId2Enum[cmbLML1_TX_PRE] = LMS7_LML1_BB2RF_PRE;
    wndId2Enum[cmbLML1_TX_PST] = LMS7_LML1_BB2RF_PST;
    wndId2Enum[cmbLML2_AIP] = LMS7_LML2_AIP;
    wndId2Enum[cmbLML2_AQP] = LMS7_LML2_AQP;
    wndId2Enum[cmbLML2_BIP] = LMS7_LML2_BIP;
    wndId2Enum[cmbLML2_BQP] = LMS7_LML2_BQP;
    wndId2Enum[cmbLML2_RX_PRE] = LMS7_LML2_RF2BB_PRE;
    wndId2Enum[cmbLML2_RX_PST] = LMS7_LML2_RF2BB_PST;
    wndId2Enum[cmbLML2_S0S] = LMS7_LML2_S0S;
    wndId2Enum[cmbLML2_S1S] = LMS7_LML2_S1S;
    wndId2Enum[cmbLML2_S2S] = LMS7_LML2_S2S;
    wndId2Enum[cmbLML2_S3S] = LMS7_LML2_S3S;
    wndId2Enum[cmbLML2_TX_PRE] = LMS7_LML2_BB2RF_PRE;
    wndId2Enum[cmbLML2_TX_PST] = LMS7_LML2_BB2RF_PST;
    wndId2Enum[rgrLML_MODE1] = LMS7_LML1_MODE;
    wndId2Enum[rgrLML_MODE2] = LMS7_LML2_MODE;
    wndId2Enum[rgrLML_TXNRXIQ1] = LMS7_LML1_TXNRXIQ;
    wndId2Enum[rgrLML_TXNRXIQ2] = LMS7_LML2_TXNRXIQ;
    wndId2Enum[chkLRST_RX_A] = LMS7_LRST_RX_A;
    wndId2Enum[chkLRST_RX_B] = LMS7_LRST_RX_B;
    wndId2Enum[chkLRST_TX_A] = LMS7_LRST_TX_A;
    wndId2Enum[chkLRST_TX_B] = LMS7_LRST_TX_B;
    wndId2Enum[cmbMCLK1SRC] = LMS7_MCLK1SRC;
    wndId2Enum[cmbRXTSPCLKA_DIV] = LMS7_RXTSPCLKA_DIV;
    wndId2Enum[chkMCLK1_PE] = LMS7_MCLK1_PE;
    wndId2Enum[cmbMCLK2SRC] = LMS7_MCLK2SRC;
    wndId2Enum[cmbTXTSPCLKA_DIV] = LMS7_TXTSPCLKA_DIV;
    wndId2Enum[chkMCLK2_PE] = LMS7_MCLK2_PE;
    wndId2Enum[chkMIMO_SISO] = LMS7_MIMO_SISO;
    wndId2Enum[chkMOD_EN] = LMS7_MOD_EN;
    wndId2Enum[chkMRST_RX_A] = LMS7_MRST_RX_A;
    wndId2Enum[chkMRST_RX_B] = LMS7_MRST_RX_B;
    wndId2Enum[chkMRST_TX_A] = LMS7_MRST_TX_A;
    wndId2Enum[chkMRST_TX_B] = LMS7_MRST_TX_B;
    wndId2Enum[chkRXDIVEN] = LMS7_RXDIVEN;
    wndId2Enum[chkRXEN_A] = LMS7_RXEN_A;
    wndId2Enum[chkRXEN_B] = LMS7_RXEN_B;
    wndId2Enum[cmbRXRDCLK_MUX] = LMS7_RXRDCLK_MUX;
    wndId2Enum[cmbRXWRCLK_MUX] = LMS7_RXWRCLK_MUX;
    wndId2Enum[chkRX_CLK_PE] = LMS7_RX_CLK_PE;
    wndId2Enum[chkSCLK_PE] = LMS7_SCLK_PE;
    wndId2Enum[rgrSCL_DS] = LMS7_SCL_DS;
    wndId2Enum[chkSCL_PE] = LMS7_SCL_PE;
    wndId2Enum[rgrSDA_DS] = LMS7_SDA_DS;
    wndId2Enum[chkSDA_PE] = LMS7_SDA_PE;
    wndId2Enum[rgrSDIO_DS] = LMS7_SDIO_DS;
    wndId2Enum[chkSDIO_PE] = LMS7_SDIO_PE;
    wndId2Enum[chkSDO_PE] = LMS7_SDO_PE;
    wndId2Enum[chkSEN_PE] = LMS7_SEN_PE;
    wndId2Enum[rgrSPIMODE] = LMS7_SPIMODE;
    wndId2Enum[chkSRST_RXFIFO] = LMS7_SRST_RXFIFO;
    wndId2Enum[chkSRST_TXFIFO] = LMS7_SRST_TXFIFO;
    wndId2Enum[chkTXDIVEN] = LMS7_TXDIVEN;
    wndId2Enum[chkTXEN_A] = LMS7_TXEN_A;
    wndId2Enum[chkTXEN_B] = LMS7_TXEN_B;
    wndId2Enum[rgrTX_MUX] = LMS7_TX_MUX;
    wndId2Enum[chkTXNRX1_PE] = LMS7_TXNRX1_PE;
    wndId2Enum[chkTXNRX2_PE] = LMS7_TXNRX2_PE;
    wndId2Enum[cmbTXRDCLK_MUX] = LMS7_TXRDCLK_MUX;
    wndId2Enum[cmbTXWRCLK_MUX] = LMS7_TXWRCLK_MUX;
    wndId2Enum[chkTX_CLK_PE] = LMS7_TX_CLK_PE;
    wndId2Enum[rgrLML_FIDM1] = LMS7_LML1_FIDM;
    wndId2Enum[rgrLML_FIDM2] = LMS7_LML2_FIDM;
    wndId2Enum[chkFCLK1_INV] = LMS7_FCLK1_INV;
    wndId2Enum[chkFCLK2_INV] = LMS7_FCLK2_INV;
    wndId2Enum[rgrDIQDIRCTR2] = LMS7_DIQDIRCTR2;
    wndId2Enum[rgrDIQDIR2] = LMS7_DIQDIR2;
    wndId2Enum[rgrDIQDIRCTR1] = LMS7_DIQDIRCTR1;
    wndId2Enum[rgrDIQDIR1] = LMS7_DIQDIR1;
    wndId2Enum[rgrENABLEDIRCTR2] = LMS7_ENABLEDIRCTR2;
    wndId2Enum[rgrENABLEDIR2] = LMS7_ENABLEDIR2;
    wndId2Enum[rgrENABLEDIRCTR1] = LMS7_ENABLEDIRCTR1;
    wndId2Enum[rgrENABLEDIR1] = LMS7_ENABLEDIR1;
    wndId2Enum[chkMCLK1_INV] = LMS7_MCLK1_INV;
    wndId2Enum[chkMCLK2_INV] = LMS7_MCLK2_INV;
    wndId2Enum[cmbFCLK1_DLY] = LMS7_FCLK1_DLY;
    wndId2Enum[cmbFCLK2_DLY] = LMS7_FCLK2_DLY;
    wndId2Enum[cmbMCLK1_DLY] = LMS7_MCLK1_DLY;
    wndId2Enum[cmbMCLK2_DLY] = LMS7_MCLK2_DLY;
    wndId2Enum[chkLML1_TRXIQPULSE] = LMS7_LML1_TRXIQPULSE;
    wndId2Enum[chkLML2_TRXIQPULSE] = LMS7_LML2_TRXIQPULSE;
    wndId2Enum[chkLML1_SISODDR] = LMS7_LML1_SISODDR;
    wndId2Enum[chkLML2_SISODDR] = LMS7_LML2_SISODDR;
...
void lms7002_pnlLimeLightPAD_view::onbtnReadVerRevMask(wxCommandEvent& event)
{
    ...
    value = ReadParam(LMS7_VER);
    lblVER->SetLabel(std::to_string(value));

    value = ReadParam(LMS7_REV);
    lblREV->SetLabel(std::to_string(value));

    value = ReadParam(LMS7_MASK);
