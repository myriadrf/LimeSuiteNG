    ...
    : ILMS7002MTab(parent, id, pos, size, style)
{
    ...
    chkCDSN_TXBTSP =
        new wxCheckBox(sbSizer121->GetStaticBox(), ID_CDSN_TXBTSP, wxT("TX TSPB"), wxDefaultPosition, wxDefaultSize, 0);
    chkCDSN_TXBTSP->SetToolTip(wxT("TX TSPB clock inversion control"));

    fgSizer191->Add(chkCDSN_TXBTSP, 0, flags, 0);

    chkCDSN_TXATSP =
        new wxCheckBox(sbSizer121->GetStaticBox(), ID_CDSN_TXATSP, wxT("TX TSPA"), wxDefaultPosition, wxDefaultSize, 0);
    chkCDSN_TXATSP->SetToolTip(wxT("TX TSPA clock inversion control"));

    fgSizer191->Add(chkCDSN_TXATSP, 0, flags, 0);

    chkCDSN_RXBTSP =
        new wxCheckBox(sbSizer121->GetStaticBox(), ID_CDSN_RXBTSP, wxT("RX TSPB"), wxDefaultPosition, wxDefaultSize, 0);
    chkCDSN_RXBTSP->SetToolTip(wxT("RX TSPB clock inversion control"));

    fgSizer191->Add(chkCDSN_RXBTSP, 0, flags, 0);

    chkCDSN_RXATSP =
        new wxCheckBox(sbSizer121->GetStaticBox(), ID_CDSN_RXATSP, wxT("RX TSPA"), wxDefaultPosition, wxDefaultSize, 0);
    chkCDSN_RXATSP->SetToolTip(wxT("RX TSPA clock inversion control"));

    fgSizer191->Add(chkCDSN_RXATSP, 0, flags, 0);

    chkCDSN_TXBLML =
        new wxCheckBox(sbSizer121->GetStaticBox(), ID_CDSN_TXBLML, wxT("TX LMLB"), wxDefaultPosition, wxDefaultSize, 0);
    chkCDSN_TXBLML->SetToolTip(wxT("TX LMLB clock inversion control"));

    fgSizer191->Add(chkCDSN_TXBLML, 0, flags, 0);

    chkCDSN_TXALML =
        new wxCheckBox(sbSizer121->GetStaticBox(), ID_CDSN_TXALML, wxT("TX LMLA"), wxDefaultPosition, wxDefaultSize, 0);
    chkCDSN_TXALML->SetToolTip(wxT("TX LMLA clock inversion control"));

    fgSizer191->Add(chkCDSN_TXALML, 0, flags, 0);

    chkCDSN_RXBLML =
        new wxCheckBox(sbSizer121->GetStaticBox(), ID_CDSN_RXBLML, wxT("RX LMLB"), wxDefaultPosition, wxDefaultSize, 0);
    chkCDSN_RXBLML->SetToolTip(wxT("RX LMLB clock inversion control"));

    fgSizer191->Add(chkCDSN_RXBLML, 0, flags, 0);

    chkCDSN_RXALML =
        new wxCheckBox(sbSizer121->GetStaticBox(), ID_CDSN_RXALML, wxT("RX LMLA"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    rgrCDS_MCLK2 = new wxRadioBox(sbSizer122->GetStaticBox(),
        ID_CDS_MCLK2,
        wxT("MCLK2"),
        wxDefaultPosition,
        wxDefaultSize,
        rgrCDS_MCLK2NChoices,
        rgrCDS_MCLK2Choices,
        1,
        wxRA_SPECIFY_COLS);
    ...
    rgrCDS_MCLK1 = new wxRadioBox(sbSizer122->GetStaticBox(),
        ID_CDS_MCLK1,
        wxT("MCLK1"),
        wxDefaultPosition,
        wxDefaultSize,
        rgrCDS_MCLK1NChoices,
        rgrCDS_MCLK1Choices,
        1,
        wxRA_SPECIFY_COLS);
    ...
    rgrCDS_TXBTSP = new wxRadioBox(sbSizer122->GetStaticBox(),
        ID_CDS_TXBTSP,
        wxT("TX TSP B"),
        wxDefaultPosition,
        wxDefaultSize,
        rgrCDS_TXBTSPNChoices,
        rgrCDS_TXBTSPChoices,
        1,
        wxRA_SPECIFY_COLS);
    ...
    rgrCDS_TXATSP = new wxRadioBox(sbSizer122->GetStaticBox(),
        ID_CDS_TXATSP,
        wxT("TX TSP A"),
        wxDefaultPosition,
        wxDefaultSize,
        rgrCDS_TXATSPNChoices,
        rgrCDS_TXATSPChoices,
        1,
        wxRA_SPECIFY_COLS);
    ...
    rgrCDS_RXBTSP = new wxRadioBox(sbSizer122->GetStaticBox(),
        ID_CDS_RXBTSP,
        wxT("RX TSP B"),
        wxDefaultPosition,
        wxDefaultSize,
        rgrCDS_RXBTSPNChoices,
        rgrCDS_RXBTSPChoices,
        1,
        wxRA_SPECIFY_COLS);
    ...
    rgrCDS_RXATSP = new wxRadioBox(sbSizer122->GetStaticBox(),
        ID_CDS_RXATSP,
        wxT("RX TSP A"),
        wxDefaultPosition,
        wxDefaultSize,
        rgrCDS_RXATSPNChoices,
        rgrCDS_RXATSPChoices,
        1,
        wxRA_SPECIFY_COLS);
    ...
    rgrCDS_TXBLML = new wxRadioBox(sbSizer122->GetStaticBox(),
        ID_CDS_TXBLML,
        wxT("TX LML B"),
        wxDefaultPosition,
        wxDefaultSize,
        rgrCDS_TXBLMLNChoices,
        rgrCDS_TXBLMLChoices,
        1,
        wxRA_SPECIFY_COLS);
    ...
    rgrCDS_TXALML = new wxRadioBox(sbSizer122->GetStaticBox(),
        ID_CDS_TXALML,
        wxT("TX LML A"),
        wxDefaultPosition,
        wxDefaultSize,
        rgrCDS_TXALMLNChoices,
        rgrCDS_TXALMLChoices,
        1,
        wxRA_SPECIFY_COLS);
    ...
    rgrCDS_RXBLML = new wxRadioBox(sbSizer122->GetStaticBox(),
        ID_CDS_RXBLML,
        wxT("RX LML B"),
        wxDefaultPosition,
        wxDefaultSize,
        rgrCDS_RXBLMLNChoices,
        rgrCDS_RXBLMLChoices,
        1,
        wxRA_SPECIFY_COLS);
    ...
    rgrCDS_RXALML = new wxRadioBox(sbSizer122->GetStaticBox(),
        ID_CDS_RXALML,
        wxT("RX LML A"),
        wxDefaultPosition,
        wxDefaultSize,
        rgrCDS_RXALMLNChoices,
        rgrCDS_RXALMLChoices,
        1,
        wxRA_SPECIFY_COLS);
    ...
    wndId2Enum[chkCDSN_MCLK1] = LMS7_CDSN_MCLK1;
    wndId2Enum[chkCDSN_MCLK2] = LMS7_CDSN_MCLK2;
    wndId2Enum[chkCDSN_RXALML] = LMS7_CDSN_RXALML;
    wndId2Enum[chkCDSN_RXATSP] = LMS7_CDSN_RXATSP;
    wndId2Enum[chkCDSN_RXBLML] = LMS7_CDSN_RXBLML;
    wndId2Enum[chkCDSN_RXBTSP] = LMS7_CDSN_RXBTSP;
    wndId2Enum[chkCDSN_TXALML] = LMS7_CDSN_TXALML;
    wndId2Enum[chkCDSN_TXATSP] = LMS7_CDSN_TXATSP;
    wndId2Enum[chkCDSN_TXBLML] = LMS7_CDSN_TXBLML;
    wndId2Enum[chkCDSN_TXBTSP] = LMS7_CDSN_TXBTSP;
    wndId2Enum[rgrCDS_MCLK1] = LMS7_CDS_MCLK1;
    wndId2Enum[rgrCDS_MCLK2] = LMS7_CDS_MCLK2;
    wndId2Enum[rgrCDS_RXALML] = LMS7_CDS_RXALML;
    wndId2Enum[rgrCDS_RXATSP] = LMS7_CDS_RXATSP;
    wndId2Enum[rgrCDS_RXBLML] = LMS7_CDS_RXBLML;
    wndId2Enum[rgrCDS_RXBTSP] = LMS7_CDS_RXBTSP;
    wndId2Enum[rgrCDS_TXALML] = LMS7_CDS_TXALML;
    wndId2Enum[rgrCDS_TXATSP] = LMS7_CDS_TXATSP;
    wndId2Enum[rgrCDS_TXBLML] = LMS7_CDS_TXBLML;
    wndId2Enum[rgrCDS_TXBTSP] = LMS7_CDS_TXBTSP;
