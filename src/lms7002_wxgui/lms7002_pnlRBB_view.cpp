    ...
    : ILMS7002MTab(parent, id, pos, size, style)
{
    ...
    sbSizerPowerDowns->Add(chkPD_LPFH_RBB, 0, flags, 0);
    ...
    sbSizerPowerDowns->Add(chkPD_LPFL_RBB, 0, flags, 0);
    ...
    sbSizerPowerDowns->Add(chkPD_PGA_RBB, 0, flags, 0);
    ...
    sbSizerPowerDowns->Add(chkEN_G_RBB, 0, flags, 0);

    wxStaticBoxSizer* sbSizer35;
    sbSizer35 =
        new wxStaticBoxSizer(new wxStaticBox(sbSizerPowerDowns->GetStaticBox(), wxID_ANY, wxT("Direct control")), wxVERTICAL);
    ...
    sbSizer35->Add(chkEN_DIR_RBB, 0, wxALIGN_LEFT, 5);

    sbSizerPowerDowns->Add(sbSizer35, 0, wxALL | wxALIGN_LEFT, 5);

    fgSizer52->Add(sbSizerPowerDowns, 0, wxEXPAND, 5);
    ...
    cmbBBLoopback->SetToolTip(wxT("This is the loopback enable signal that is enabled when high band LPFH_RBB or low band LPFL_RBB "
                                  " is selected for the loopback path. \n0x0115 [15] EN_LB_LPFH_RBB\n0x0115 [14] EN_LB_LPFL_RBB"));

    fgSizer53->Add(cmbBBLoopback, 1, wxEXPAND, 5);
    ...
    fgSizer53->Add(cmbINPUT_CTL_PGA_RBB, 0, wxEXPAND, 0);
    ...
    cmbC_CTL_PGA_RBB =
        new NumericSlider(this, ID_C_CTL_PGA_RBB, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 255, 0);
    fgSizer53->Add(cmbC_CTL_PGA_RBB, 0, wxEXPAND, 5);

    fgSizer259->Add(fgSizer53, 0, wxEXPAND, 0);
    ...
    rgrOSW_PGA_RBB = new wxRadioBox(this,
        ID_OSW_PGA_RBB,
        wxT("PGA output connected to"),
        wxDefaultPosition,
        wxDefaultSize,
        rgrOSW_PGA_RBBNChoices,
        rgrOSW_PGA_RBBChoices,
        2,
        wxRA_SPECIFY_COLS);
    rgrOSW_PGA_RBB->SetSelection(1);
    rgrOSW_PGA_RBB->SetToolTip(
        wxT("There are two instances of the PGA circuit in the design. The output of the RBB_LPF blocks are connected the input of "
            "these PGA blocks (common). The output of one of them is connected to two pads pgaoutn and pgaoutp and the output of "
            "the other PGA is connected directly to the ADC input"));

    fgSizer259->Add(rgrOSW_PGA_RBB, 0, wxALIGN_LEFT | wxALIGN_TOP, 0);
    ...
    fgSizer54->Add(cmbR_CTL_LPF_RBB, 0, wxEXPAND, 0);
    ...
    cmbC_CTL_LPFH_RBB = new NumericSlider(sbSizerRCtimeConstants->GetStaticBox(),
        ID_C_CTL_LPFH_RBB,
        wxEmptyString,
        wxDefaultPosition,
        wxDefaultSize,
    ...
    cmbC_CTL_LPFL_RBB = new NumericSlider(sbSizerRCtimeConstants->GetStaticBox(),
        ID_C_CTL_LPFL_RBB,
        wxEmptyString,
        wxDefaultPosition,
        wxDefaultSize,
    ...
    sbSizerRxFilters =
        new wxStaticBoxSizer(new wxStaticBox(sbSizerRCtimeConstants->GetStaticBox(), wxID_ANY, wxT("Rx Filters")), wxVERTICAL);
    ...
    fgSizer56->Add(cmbICT_LPF_IN_RBB, 0, wxEXPAND, 0);

    ID_STATICTEXT10 =
        new wxStaticText(sbSizerOpAmp->GetStaticBox(), wxID_ANY, wxT("Output stage reference bias current (RBB_LPF)"));
    ...
    fgSizer56->Add(cmbICT_LPF_OUT_RBB, 0, wxEXPAND, 0);
    ...
    fgSizer56->Add(cmbICT_PGA_OUT_RBB, 0, wxEXPAND, 0);
    ...
    fgSizer56->Add(cmbICT_PGA_IN_RBB, 0, wxEXPAND, 0);
    ...
    sbSizerOpAmp->Add(fgSizer56, 0, wxEXPAND, 0);
    ...
    wndId2Enum[cmbC_CTL_LPFH_RBB] = LMS7_C_CTL_LPFH_RBB;
    wndId2Enum[cmbC_CTL_LPFL_RBB] = LMS7_C_CTL_LPFL_RBB;
    wndId2Enum[cmbC_CTL_PGA_RBB] = LMS7_C_CTL_PGA_RBB;
    wndId2Enum[chkEN_G_RBB] = LMS7_EN_G_RBB;
    wndId2Enum[cmbG_PGA_RBB] = LMS7_G_PGA_RBB;
    wndId2Enum[cmbICT_LPF_IN_RBB] = LMS7_ICT_LPF_IN_RBB;
    wndId2Enum[cmbICT_LPF_OUT_RBB] = LMS7_ICT_LPF_OUT_RBB;
    wndId2Enum[cmbICT_PGA_IN_RBB] = LMS7_ICT_PGA_IN_RBB;
    wndId2Enum[cmbICT_PGA_OUT_RBB] = LMS7_ICT_PGA_OUT_RBB;
    wndId2Enum[cmbINPUT_CTL_PGA_RBB] = LMS7_INPUT_CTL_PGA_RBB;
    wndId2Enum[rgrOSW_PGA_RBB] = LMS7_OSW_PGA_RBB;
    wndId2Enum[chkPD_LPFH_RBB] = LMS7_PD_LPFH_RBB;
    wndId2Enum[chkPD_LPFL_RBB] = LMS7_PD_LPFL_RBB;
    wndId2Enum[chkPD_PGA_RBB] = LMS7_PD_PGA_RBB;
    wndId2Enum[cmbRCC_CTL_LPFH_RBB] = LMS7_RCC_CTL_LPFH_RBB;
    wndId2Enum[cmbRCC_CTL_LPFL_RBB] = LMS7_RCC_CTL_LPFL_RBB;
    wndId2Enum[cmbRCC_CTL_PGA_RBB] = LMS7_RCC_CTL_PGA_RBB;
    wndId2Enum[cmbR_CTL_LPF_RBB] = LMS7_R_CTL_LPF_RBB;
    wndId2Enum[chkEN_DIR_RBB] = LMS7_EN_DIR_RBB;
...
void lms7002_pnlRBB_view::OncmbBBLoopbackSelected(wxCommandEvent& event)
{
    ...
    {
    case 0:
        WriteParam(LMS7_EN_LB_LPFH_RBB, true);
        WriteParam(LMS7_EN_LB_LPFL_RBB, false);
        break;
    case 1:
        WriteParam(LMS7_EN_LB_LPFH_RBB, false);
        WriteParam(LMS7_EN_LB_LPFL_RBB, true);
        break;
    case 2:
        WriteParam(LMS7_EN_LB_LPFH_RBB, false);
        WriteParam(LMS7_EN_LB_LPFL_RBB, false);
...
void lms7002_pnlRBB_view::UpdateGUI()
{
    ...
    EN_LB_LPFH_RBBvalue = ReadParam(LMS7_EN_LB_LPFH_RBB);

    uint16_t EN_LB_LPFL_RBBvalue;
    EN_LB_LPFL_RBBvalue = ReadParam(LMS7_EN_LB_LPFL_RBB);
