    ...
    : ILMS7002MTab(parent, id, pos, size, style)
{
    ...
    wndId2Enum[rgrMODE_TX] = LMS7_MODE_TX;
    wndId2Enum[chkBSTART_TXTSP] = LMS7_BSTART_TXTSP;
    wndId2Enum[chkCMIX_BYP_TXTSP] = LMS7_CMIX_BYP_TXTSP;
    wndId2Enum[cmbCMIX_GAIN_TXTSP] = LMS7_CMIX_GAIN_TXTSP;
    wndId2Enum[cmbDCCORRI_TXTSP] = LMS7_DCCORRI_TXTSP;
    wndId2Enum[cmbDCCORRQ_TXTSP] = LMS7_DCCORRQ_TXTSP;
    wndId2Enum[chkDC_BYP_TXTSP] = LMS7_DC_BYP_TXTSP;
    wndId2Enum[chkEN_TXTSP] = LMS7_EN_TXTSP;
    wndId2Enum[cmbGCORRI_TXTSP] = LMS7_GCORRI_TXTSP;
    wndId2Enum[cmbGCORRQ_TXTSP] = LMS7_GCORRQ_TXTSP;
    wndId2Enum[chkGC_BYP_TXTSP] = LMS7_GC_BYP_TXTSP;
    wndId2Enum[chkGFIR1_BYP_TXTSP] = LMS7_GFIR1_BYP_TXTSP;
    wndId2Enum[cmbGFIR1_L_TXTSP] = LMS7_GFIR1_L_TXTSP;
    wndId2Enum[cmbGFIR1_N_TXTSP] = LMS7_GFIR1_N_TXTSP;
    wndId2Enum[chkGFIR2_BYP_TXTSP] = LMS7_GFIR2_BYP_TXTSP;
    wndId2Enum[cmbGFIR2_L_TXTSP] = LMS7_GFIR2_L_TXTSP;
    wndId2Enum[cmbGFIR2_N_TXTSP] = LMS7_GFIR2_N_TXTSP;
    wndId2Enum[chkGFIR3_BYP_TXTSP] = LMS7_GFIR3_BYP_TXTSP;
    wndId2Enum[cmbGFIR3_L_TXTSP] = LMS7_GFIR3_L_TXTSP;
    wndId2Enum[cmbGFIR3_N_TXTSP] = LMS7_GFIR3_N_TXTSP;
    wndId2Enum[cmbHBI_OVR_TXTSP] = LMS7_HBI_OVR_TXTSP;
    wndId2Enum[cmbIQCORR_TXTSP] = LMS7_IQCORR_TXTSP;
    wndId2Enum[chkISINC_BYP_TXTSP] = LMS7_ISINC_BYP_TXTSP;
    wndId2Enum[chkPH_BYP_TXTSP] = LMS7_PH_BYP_TXTSP;
    wndId2Enum[cmbCMIX_SC_TXTSP] = LMS7_CMIX_SC_TXTSP;

    wndId2Enum[rgrTSGFCW_TXTSP] = LMS7_TSGFCW_TXTSP;
    wndId2Enum[chkTSGSWAPIQ_TXTSP] = LMS7_TSGSWAPIQ_TXTSP;
    wndId2Enum[rgrTSGMODE_TXTSP] = LMS7_TSGMODE_TXTSP;
    wndId2Enum[rgrINSEL_TXTSP] = LMS7_INSEL_TXTSP;
    wndId2Enum[rgrTSGFC_TXTSP] = LMS7_TSGFC_TXTSP;
    wndId2Enum[cmbDTHBIT_TX] = LMS7_DTHBIT_TX;

    wndId2Enum[rgrSEL0] = LMS7_SEL_TX;
    wndId2Enum[rgrSEL01] = LMS7_SEL_TX;
    wndId2Enum[rgrSEL02] = LMS7_SEL_TX;
    wndId2Enum[rgrSEL03] = LMS7_SEL_TX;
    wndId2Enum[rgrSEL04] = LMS7_SEL_TX;
    wndId2Enum[rgrSEL05] = LMS7_SEL_TX;
    wndId2Enum[rgrSEL06] = LMS7_SEL_TX;
    wndId2Enum[rgrSEL07] = LMS7_SEL_TX;
    wndId2Enum[rgrSEL08] = LMS7_SEL_TX;
    wndId2Enum[rgrSEL09] = LMS7_SEL_TX;
    wndId2Enum[rgrSEL10] = LMS7_SEL_TX;
    wndId2Enum[rgrSEL11] = LMS7_SEL_TX;
    wndId2Enum[rgrSEL12] = LMS7_SEL_TX;
    wndId2Enum[rgrSEL13] = LMS7_SEL_TX;
    wndId2Enum[rgrSEL14] = LMS7_SEL_TX;
    wndId2Enum[rgrSEL15] = LMS7_SEL_TX;
...
void lms7002_pnlTXTSP_view::Initialize(LMS7002M* pControl)
{
    ...
    uint16_t value;
    if (LMS_ReadParam(lmsControl, LMS7_MASK, &value) != 0 || value != 0)
        value = 1;
    wxArrayString temp;
    temp.clear();
    temp.push_back("-6 dB");
...
void lms7002_pnlTXTSP_view::ParameterChangeHandler(wxCommandEvent& event)
{
    ...
    {
        WriteParam(LMS7_CMIX_GAIN_TXTSP_R3, value % 0x2);
...
void lms7002_pnlTXTSP_view::OnNCOSelectionChange(wxCommandEvent& event)
{
    ...
    WriteParam(LMS7_SEL_TX, value);
}

void lms7002_pnlTXTSP_view::onbtnReadBISTSignature(wxCommandEvent& event)
{
    uint16_t value;
    LMS_ReadParam(lmsControl, LMS7_BSTATE_TXTSP, &value);
    lblBSTATE_TXTSP->SetLabel(std::to_string(value));
    LMS_ReadParam(lmsControl, LMS7_BSIGI_TXTSP, &value);
    lblBSIGI_TXTSP->SetLabel(wxString::Format("0x%0.6X", value));
    LMS_ReadParam(lmsControl, LMS7_BSIGQ_TXTSP, &value);
...
void lms7002_pnlTXTSP_view::OnbtnLoadDCIClick(wxCommandEvent& event)
{
    ...
    WriteParam(LMS7_DC_REG_TXTSP, value);
    WriteParam(LMS7_TSGDCLDI_TXTSP, 0);
    WriteParam(LMS7_TSGDCLDI_TXTSP, 1);
    WriteParam(LMS7_TSGDCLDI_TXTSP, 0);
}
...
void lms7002_pnlTXTSP_view::OnbtnLoadDCQClick(wxCommandEvent& event)
{
    ...
    txtDC_REG_TXTSP->GetValue().ToLong(&value, 16);
    WriteParam(LMS7_DC_REG_TXTSP, value);
    WriteParam(LMS7_TSGDCLDQ_TXTSP, 0);
    WriteParam(LMS7_TSGDCLDQ_TXTSP, 1);
    WriteParam(LMS7_TSGDCLDQ_TXTSP, 0);
}
...
{
    WriteParam(LMS7_MODE_TX, rgrMODE_TX->GetSelection());
...
void lms7002_pnlTXTSP_view::UpdateGUI()
{
    ...
    uint16_t hbi;
    LMS_ReadParam(lmsControl, LMS7_HBI_OVR_TXTSP, &hbi);
    cmbHBI_OVR_TXTSP->SetSelection(value2index(hbi, hbi_ovr_txtsp_IndexValuePairs));

    int16_t value;
    LMS_ReadParam(lmsControl, LMS7_TSGFCW_TXTSP, reinterpret_cast<uint16_t*>(&value));

    rgrTSGFCW_TXTSP->SetSelection(value2index(value, tsgfcw_txtsp_IndexValuePairs));

    LMS_ReadParam(lmsControl, LMS7_IQCORR_TXTSP, reinterpret_cast<uint16_t*>(&value));
    int bitsToShift = (15 - LMS7_IQCORR_TXTSP.msb - LMS7_IQCORR_TXTSP.lsb);
    value = value << bitsToShift;
    value = value >> bitsToShift;
    cmbIQCORR_TXTSP->SetValue(value);

    LMS_ReadParam(lmsControl, LMS7_SEL_TX, reinterpret_cast<uint16_t*>(&value));
    assert(rgrNCOselections.size() == 16);
    rgrNCOselections[value & 0xF]->SetValue(true);
    UpdateNCOinputs();

    LMS_ReadParam(lmsControl, LMS7_DCCORRI_TXTSP, reinterpret_cast<uint16_t*>(&value));
    int8_t dccorr = value;
    cmbDCCORRI_TXTSP->SetValue(dccorr);
    LMS_ReadParam(lmsControl, LMS7_DCCORRQ_TXTSP, reinterpret_cast<uint16_t*>(&value));
    dccorr = value;
    cmbDCCORRQ_TXTSP->SetValue(dccorr);

    uint16_t g_cmix;
    LMS_ReadParam(lmsControl, LMS7_CMIX_GAIN_TXTSP, &g_cmix);
    value = value2index(g_cmix, cmix_gain_txtsp_IndexValuePairs);
    LMS_ReadParam(lmsControl, LMS7_CMIX_GAIN_TXTSP_R3, &g_cmix);
    if (g_cmix)
        value |= 1;
    else
        value &= ~1;
    ...
    uint16_t ch;
    LMS_ReadParam(lmsControl, LMS7_MAC, &ch);
    ch = (ch == 2) ? 1 : 0;
    ch += 2 * LMS7SuiteAppFrame::m_lmsSelection;
    ...
    LMS_ReadParam(lmsControl, LMS7_MAC, reinterpret_cast<uint16_t*>(&value));
    if (value >= 2)
    {
        LMS_ReadParam(lmsControl, LMS7_MIMO_SISO, reinterpret_cast<uint16_t*>(&value));
        if (value != 0)
