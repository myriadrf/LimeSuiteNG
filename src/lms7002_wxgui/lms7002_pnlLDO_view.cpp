    ...
    : ILMS7002MTab(parent, id, pos, size, style)
{
    ...
    wndId2Enum[chkEN_G_LDO] = LMS7_EN_G_LDO;
    wndId2Enum[chkEN_G_LDOP] = LMS7_EN_G_LDOP;
    wndId2Enum[chkEN_LDO_AFE] = LMS7_EN_LDO_AFE;
    wndId2Enum[chkEN_LDO_CPGN] = LMS7_EN_LDO_CPGN;
    wndId2Enum[chkEN_LDO_CPSXR] = LMS7_EN_LDO_CPSXR;
    wndId2Enum[chkEN_LDO_CPSXT] = LMS7_EN_LDO_CPSXT;
    wndId2Enum[chkEN_LDO_DIG] = LMS7_EN_LDO_DIG;
    wndId2Enum[chkEN_LDO_DIGGN] = LMS7_EN_LDO_DIGGN;
    wndId2Enum[chkPD_LDO_DIGIp1] = LMS7_PD_LDO_DIGIp1;
    wndId2Enum[chkPD_LDO_DIGIp2] = LMS7_PD_LDO_DIGIp2;
    wndId2Enum[chkEN_LDO_DIGSXR] = LMS7_EN_LDO_DIGSXR;
    wndId2Enum[chkEN_LDO_DIGSXT] = LMS7_EN_LDO_DIGSXT;
    wndId2Enum[chkEN_LDO_DIVGN] = LMS7_EN_LDO_DIVGN;
    wndId2Enum[chkEN_LDO_DIVSXR] = LMS7_EN_LDO_DIVSXR;
    wndId2Enum[chkEN_LDO_DIVSXT] = LMS7_EN_LDO_DIVSXT;
    wndId2Enum[chkEN_LDO_LNA12] = LMS7_EN_LDO_LNA12;
    wndId2Enum[chkEN_LDO_LNA14] = LMS7_EN_LDO_LNA14;
    wndId2Enum[chkEN_LDO_MXRFE] = LMS7_EN_LDO_MXRFE;
    wndId2Enum[chkEN_LDO_RBB] = LMS7_EN_LDO_RBB;
    wndId2Enum[chkEN_LDO_RXBUF] = LMS7_EN_LDO_RXBUF;
    wndId2Enum[chkPD_LDO_SPIBUF] = LMS7_PD_LDO_SPIBUF;
    wndId2Enum[chkEN_LDO_TBB] = LMS7_EN_LDO_TBB;
    wndId2Enum[chkEN_LDO_TIA12] = LMS7_EN_LDO_TIA12;
    wndId2Enum[chkEN_LDO_TIA14] = LMS7_EN_LDO_TIA14;
    wndId2Enum[chkEN_LDO_TLOB] = LMS7_EN_LDO_TLOB;
    wndId2Enum[chkEN_LDO_TPAD] = LMS7_EN_LDO_TPAD;
    wndId2Enum[chkEN_LDO_TXBUF] = LMS7_EN_LDO_TXBUF;
    wndId2Enum[chkEN_LDO_VCOGN] = LMS7_EN_LDO_VCOGN;
    wndId2Enum[chkEN_LDO_VCOSXR] = LMS7_EN_LDO_VCOSXR;
    wndId2Enum[chkEN_LDO_VCOSXT] = LMS7_EN_LDO_VCOSXT;
    wndId2Enum[chkEN_LOADIMP_LDO_AFE] = LMS7_EN_LOADIMP_LDO_AFE;
    wndId2Enum[chkEN_LOADIMP_LDO_CPGN] = LMS7_EN_LOADIMP_LDO_CPGN;
    wndId2Enum[chkEN_LOADIMP_LDO_CPSXR] = LMS7_EN_LOADIMP_LDO_CPSXR;
    wndId2Enum[chkEN_LOADIMP_LDO_CPSXT] = LMS7_EN_LOADIMP_LDO_CPSXT;
    wndId2Enum[chkEN_LOADIMP_LDO_DIG] = LMS7_EN_LOADIMP_LDO_DIG;
    wndId2Enum[chkEN_LOADIMP_LDO_DIGGN] = LMS7_EN_LOADIMP_LDO_DIGGN;
    wndId2Enum[chkEN_LOADIMP_LDO_DIGIp1] = LMS7_EN_LOADIMP_LDO_DIGIp1;
    wndId2Enum[chkEN_LOADIMP_LDO_DIGIp2] = LMS7_EN_LOADIMP_LDO_DIGIp2;
    wndId2Enum[chkEN_LOADIMP_LDO_DIGSXR] = LMS7_EN_LOADIMP_LDO_DIGSXR;
    wndId2Enum[chkEN_LOADIMP_LDO_DIGSXT] = LMS7_EN_LOADIMP_LDO_DIGSXT;
    wndId2Enum[chkEN_LOADIMP_LDO_DIVGN] = LMS7_EN_LOADIMP_LDO_DIVGN;
    wndId2Enum[chkEN_LOADIMP_LDO_DIVSXR] = LMS7_EN_LOADIMP_LDO_DIVSXR;
    wndId2Enum[chkEN_LOADIMP_LDO_DIVSXT] = LMS7_EN_LOADIMP_LDO_DIVSXT;
    wndId2Enum[chkEN_LOADIMP_LDO_LNA12] = LMS7_EN_LOADIMP_LDO_LNA12;
    wndId2Enum[chkEN_LOADIMP_LDO_LNA14] = LMS7_EN_LOADIMP_LDO_LNA14;
    wndId2Enum[chkEN_LOADIMP_LDO_MXRFE] = LMS7_EN_LOADIMP_LDO_MXRFE;
    wndId2Enum[chkEN_LOADIMP_LDO_RBB] = LMS7_EN_LOADIMP_LDO_RBB;
    wndId2Enum[chkEN_LOADIMP_LDO_RXBUF] = LMS7_EN_LOADIMP_LDO_RXBUF;
    wndId2Enum[chkEN_LOADIMP_LDO_SPIBUF] = LMS7_EN_LOADIMP_LDO_SPIBUF;
    wndId2Enum[chkEN_LOADIMP_LDO_TBB] = LMS7_EN_LOADIMP_LDO_TBB;
    wndId2Enum[chkEN_LOADIMP_LDO_TIA12] = LMS7_EN_LOADIMP_LDO_TIA12;
    wndId2Enum[chkEN_LOADIMP_LDO_TIA14] = LMS7_EN_LOADIMP_LDO_TIA14;
    wndId2Enum[chkEN_LOADIMP_LDO_TLOB] = LMS7_EN_LOADIMP_LDO_TLOB;
    wndId2Enum[chkEN_LOADIMP_LDO_TPAD] = LMS7_EN_LOADIMP_LDO_TPAD;
    wndId2Enum[chkEN_LOADIMP_LDO_TXBUF] = LMS7_EN_LOADIMP_LDO_TXBUF;
    wndId2Enum[chkEN_LOADIMP_LDO_VCOGN] = LMS7_EN_LOADIMP_LDO_VCOGN;
    wndId2Enum[chkEN_LOADIMP_LDO_VCOSXR] = LMS7_EN_LOADIMP_LDO_VCOSXR;
    wndId2Enum[chkEN_LOADIMP_LDO_VCOSXT] = LMS7_EN_LOADIMP_LDO_VCOSXT;
    wndId2Enum[cmbRDIV_AFE] = LMS7_RDIV_AFE;
    wndId2Enum[cmbRDIV_CPGN] = LMS7_RDIV_CPGN;
    wndId2Enum[cmbRDIV_CPSXR] = LMS7_RDIV_CPSXR;
    wndId2Enum[cmbRDIV_CPSXT] = LMS7_RDIV_CPSXT;
    wndId2Enum[cmbRDIV_DIG] = LMS7_RDIV_DIG;
    wndId2Enum[cmbRDIV_DIGGN] = LMS7_RDIV_DIGGN;
    wndId2Enum[cmbRDIV_DIGIp1] = LMS7_RDIV_DIGIp1;
    wndId2Enum[cmbRDIV_DIGIp2] = LMS7_RDIV_DIGIp2;
    wndId2Enum[cmbRDIV_DIGSXR] = LMS7_RDIV_DIGSXR;
    wndId2Enum[cmbRDIV_DIGSXT] = LMS7_RDIV_DIGSXT;
    wndId2Enum[cmbRDIV_DIVGN] = LMS7_RDIV_DIVGN;
    wndId2Enum[cmbRDIV_DIVSXR] = LMS7_RDIV_DIVSXR;
    wndId2Enum[cmbRDIV_DIVSXT] = LMS7_RDIV_DIVSXT;
    wndId2Enum[cmbRDIV_LNA12] = LMS7_RDIV_LNA12;
    wndId2Enum[cmbRDIV_LNA14] = LMS7_RDIV_LNA14;
    wndId2Enum[cmbRDIV_MXRFE] = LMS7_RDIV_MXRFE;
    wndId2Enum[cmbRDIV_RBB] = LMS7_RDIV_RBB;
    wndId2Enum[cmbRDIV_RXBUF] = LMS7_RDIV_RXBUF;
    wndId2Enum[cmbRDIV_SPIBUF] = LMS7_RDIV_SPIBUF;
    wndId2Enum[cmbRDIV_TBB] = LMS7_RDIV_TBB;
    wndId2Enum[cmbRDIV_TIA12] = LMS7_RDIV_TIA12;
    wndId2Enum[cmbRDIV_TIA14] = LMS7_RDIV_TIA14;
    wndId2Enum[cmbRDIV_TLOB] = LMS7_RDIV_TLOB;
    wndId2Enum[cmbRDIV_TPAD] = LMS7_RDIV_TPAD;
    wndId2Enum[cmbRDIV_TXBUF] = LMS7_RDIV_TXBUF;
    wndId2Enum[cmbRDIV_VCOGN] = LMS7_RDIV_VCOGN;
    wndId2Enum[cmbRDIV_VCOSXR] = LMS7_RDIV_VCOSXR;
    wndId2Enum[cmbRDIV_VCOSXT] = LMS7_RDIV_VCOSXT;
    wndId2Enum[chkSPDUP_LDO_AFE] = LMS7_SPDUP_LDO_AFE;
    wndId2Enum[chkSPDUP_LDO_CPGN] = LMS7_SPDUP_LDO_CPGN;
    wndId2Enum[chkSPDUP_LDO_CPSXR] = LMS7_SPDUP_LDO_CPSXR;
    wndId2Enum[chkSPDUP_LDO_CPSXT] = LMS7_SPDUP_LDO_CPSXT;
    wndId2Enum[chkSPDUP_LDO_DIG] = LMS7_SPDUP_LDO_DIG;
    wndId2Enum[chkSPDUP_LDO_DIGGN] = LMS7_SPDUP_LDO_DIGGN;
    wndId2Enum[chkSPDUP_LDO_DIGIp1] = LMS7_SPDUP_LDO_DIGIp1;
    wndId2Enum[chkSPDUP_LDO_DIGIp2] = LMS7_SPDUP_LDO_DIGIp2;
    wndId2Enum[chkSPDUP_LDO_DIGSXR] = LMS7_SPDUP_LDO_DIGSXR;
    wndId2Enum[chkSPDUP_LDO_DIGSXT] = LMS7_SPDUP_LDO_DIGSXT;
    wndId2Enum[chkSPDUP_LDO_DIVGN] = LMS7_SPDUP_LDO_DIVGN;
    wndId2Enum[chkSPDUP_LDO_DIVSXR] = LMS7_SPDUP_LDO_DIVSXR;
    wndId2Enum[chkSPDUP_LDO_DIVSXT] = LMS7_SPDUP_LDO_DIVSXT;
    wndId2Enum[chkSPDUP_LDO_LNA12] = LMS7_SPDUP_LDO_LNA12;
    wndId2Enum[chkSPDUP_LDO_LNA14] = LMS7_SPDUP_LDO_LNA14;
    wndId2Enum[chkSPDUP_LDO_MXRFE] = LMS7_SPDUP_LDO_MXRFE;
    wndId2Enum[chkSPDUP_LDO_RBB] = LMS7_SPDUP_LDO_RBB;
    wndId2Enum[chkSPDUP_LDO_RXBUF] = LMS7_SPDUP_LDO_RXBUF;
    wndId2Enum[chkSPDUP_LDO_SPIBUF] = LMS7_SPDUP_LDO_SPIBUF;
    wndId2Enum[chkSPDUP_LDO_TBB] = LMS7_SPDUP_LDO_TBB;
    wndId2Enum[chkSPDUP_LDO_TIA12] = LMS7_SPDUP_LDO_TIA12;
    wndId2Enum[chkSPDUP_LDO_TIA14] = LMS7_SPDUP_LDO_TIA14;
    wndId2Enum[chkSPDUP_LDO_TLOB] = LMS7_SPDUP_LDO_TLOB;
    wndId2Enum[chkSPDUP_LDO_TPAD] = LMS7_SPDUP_LDO_TPAD;
    wndId2Enum[chkSPDUP_LDO_TXBUF] = LMS7_SPDUP_LDO_TXBUF;
    wndId2Enum[chkSPDUP_LDO_VCOGN] = LMS7_SPDUP_LDO_VCOGN;
    wndId2Enum[chkSPDUP_LDO_VCOSXR] = LMS7_SPDUP_LDO_VCOSXR;
    wndId2Enum[chkSPDUP_LDO_VCOSXT] = LMS7_SPDUP_LDO_VCOSXT;
    wndId2Enum[cmbISINK_SPIBUFF] = LMS7_ISINK_SPIBUFF;
    wxArrayString temp;
    temp.clear();
    for (int i = 0; i < 256; ++i)
    {
