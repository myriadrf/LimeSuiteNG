...
void dlgMarkers::AddMarker(int id)
{
    ...
    wxStaticText* StaticText2 = new wxStaticText(
        pnl, markerId, wxString::Format("Marker%i freq(MHz):", id), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT2"));
    FlexGridSizer3->Add(StaticText2, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
    wxTextCtrl* TextCtrl1 = new wxTextCtrl(
        pnl, markerId, _T("0.0"), wxDefaultPosition, wxSize(48, -1), wxTE_PROCESS_ENTER, wxDefaultValidator, _T("ID_TEXTCTRL1"));
    freqs.push_back(TextCtrl1);
    FlexGridSizer3->Add(TextCtrl1, 1, wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
    wxStaticText* StaticText3 =
        new wxStaticText(pnl, markerId, _T("value (dB):"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT3"));
    FlexGridSizer3->Add(StaticText3, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
    wxStaticText* StaticText4 =
        new wxStaticText(pnl, markerId, _T("0.0"), wxDefaultPosition, wxSize(168, -1), 0, _T("ID_STATICTEXT4"));
...
void dlgMarkers::AddDeltas()
{
    ...
    for (int i = 0; i < 5; ++i)
    {
        ...
        wxStaticText* lblDelta0 =
            new wxStaticText(pnl, wxNewId(), _T("0.0 dB"), wxDefaultPosition, wxSize(180, -1), 0, _T("ID_STATICTEXT2"));
