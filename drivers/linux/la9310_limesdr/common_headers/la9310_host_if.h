...
#define LA9310_EVT_UPDATE_EVT_CFG(pIrqEvtRegs, nIrqEvts) \
    do \
    { \
...
#define LA9310_EVT_SET_EVT_CFG(pIrqEvtRegs, nIrqWrds, nIrqEvts) \
    do \
    { \
...
typedef enum { LA9310_BOOT_SRC_RSV0, LA9310_BOOT_SRC_RSV1, LA9310_BOOT_SRC_I2C, LA9310_BOOT_SRC_PCIE } la9310_boot_src_t;
...
#define IRQ_EVT_IPC_EVT_MASK \
    (LA9310_IRQ_EVT(IRQ_EVT_IPC_CH1_BIT) | LA9310_IRQ_EVT(IRQ_EVT_IPC_CH2_BIT) | LA9310_IRQ_EVT(IRQ_EVT_IPC_CH3_BIT) | \
