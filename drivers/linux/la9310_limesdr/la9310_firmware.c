...
int la9310_load_rtos_img(struct la9310_dev* la9310_dev)
{
    ...
    /*Before writing boot header,write 0000_9401h at ccsr adrress
      0x34008d0h*/
    pcie_amba_err_offset = PCIE_RHOM_DBI_BASE + AMBA_ERROR_RESPONSE_DEFAULT_OFF;
    ...
    */
    boot_header = (struct la9310_boot_header*)((u8*)tcm_region->vaddr + LA9310_EP_BOOT_HDR_OFFSET);
