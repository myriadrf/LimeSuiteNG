...
extern const char* VSPA_stat_rx_string[STATS_RX_MAX + 1];
extern const char* VSPA_stat_tx_string[STATS_TX_MAX + 1];
extern const char* VSPA_stat_gbl_string[STATS_GBL_MAX + 1];
