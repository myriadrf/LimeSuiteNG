...
.. important::
   ...
   Compared to standard build procedure, building library package using conda-build tool takes more time (10-15 min.) and resources. For development purposes it is advised to build from source using cmake. See :ref:`windows-lib-build-ref`.
