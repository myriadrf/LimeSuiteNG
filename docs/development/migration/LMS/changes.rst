...
This is the table noting all the known differences to the functionality of the legacy LMS API included in LimeSuiteNG compared to the previous iteration of LimeSuite (version 23.11.0).
